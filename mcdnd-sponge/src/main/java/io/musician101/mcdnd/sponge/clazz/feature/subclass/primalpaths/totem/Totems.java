...
import io.musician101.mcdnd.sponge.clazz.feature.subclass.primalpaths.totem.Totem.BearTotem;
import io.musician101.mcdnd.sponge.clazz.feature.subclass.primalpaths.totem.Totem.EagleTotem;
import io.musician101.mcdnd.sponge.clazz.feature.subclass.primalpaths.totem.Totem.WolfTotem;
...
public class Totems {
    ...
    public static final Map<Integer, List<Totem>> ALL_TOTEMS = ImmutableMap.<Integer, List<Totem>>builder().put(3, Arrays.asList(BEAR_3, EAGLE_3, WOLF_3)).put(6, Arrays.asList(BEAR_6, EAGLE_6, WOLF_6)).put(14, Arrays.asList(BEAR_14, EAGLE_14, WOLF_14)).build();
}
