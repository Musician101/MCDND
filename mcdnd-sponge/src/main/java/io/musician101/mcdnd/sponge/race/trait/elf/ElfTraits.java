...
public class ElfTraits
{
    public static final Trait ABILITY_SCORE_INCREASE = builder().name("Ability Score Increase")
            ...
            .addProperty(MCDNDKeys.ABILITY_SCORE_INCREASE, Collections.singletonMap(AbilityScoreTypes.DEXTERITY, 2))
            .build();
    ...
    public static final Trait ALIGNMENT = builder().name("Alignment")
            ...
            .build();
    public static final Trait KEEN_SENSES = builder().name("Keen Senses")
            .description("You have proficiency in the Perception skill.")
            .addProperty(MCDNDKeys.SKILL_TYPE, SkillTypes.PERCEPTION)
            .build();
    public static final Trait FEY_ANCESTRY = builder().name("Fey Ancestry")
            .description("You have advantage on saving throws against being charmed, and magic can't put you to sleep.")
            .build();
    public static final Trait TRANCE = builder().name("Trance")
