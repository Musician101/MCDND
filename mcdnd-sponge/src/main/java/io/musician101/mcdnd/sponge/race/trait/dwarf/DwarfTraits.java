...
public class DwarfTraits
{
    ...
    public static final Trait DARKVISION = builder().name("Darkvision")
            .description("Accustomed to life underground, you have superior vision in dark and dim conditions.").build();
    public static final Trait LANGUAGES = builder().name("Languages")
            ...
            .addProperty(MCDNDKeys.LANGUAGES, Arrays.asList(Languages.COMMON, Languages.DWARVISH)).build();
    ...
    public static final Trait SPEED = builder().name("Speed")
            ...
            .addProperty(MCDNDKeys.INTEGER, 25).build();
    public static final Trait DWARVEN_RESILIENCE = builder().name("Dwarven Resilience")
            .description("You have advantage on saving throws against poison, and you have resistance against poison damage.")
            .addProperty(MCDNDKeys.DAMAGE_TYPE, MCDNDDamageTypes.POISON).build();
    public static final Trait STONECUNNING = builder().name("Stonecunning")
            ...
            .addProperty(MCDNDKeys.SKILL_TYPE, SkillTypes.HISTORY).build();
    public static final Trait SUBRACES = builder().name("Subraces")
            ...
            .addProperty(MCDNDKeys.SUBRACES, ImmutableMap.<String, List<Trait>>builder().put("Hill", HillDwarfTraits.ALL)
                    .put("Mountain", MountainDwarfTraits.DWARF_MOUNTAIN_TRAITS).build()).build();
