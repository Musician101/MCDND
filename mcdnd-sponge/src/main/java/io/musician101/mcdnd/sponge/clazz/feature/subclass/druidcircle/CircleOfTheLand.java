...
public class CircleOfTheLand
{
    ...
    public static final Feature CIRCLE_SPELLS = builder().name("Circle Spells").levelRequirement(3)
            ...
            .addProperty(MCDNDKeys.TABLES, Arrays.asList(Table.builder().name("Arctic")
                    ...
                    .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.HOLD_PERSON, Spells.SPIKE_GROWTH),
                            Arrays.asList(Spells.SLEET_STORM, Spells.SLOW),
                            Arrays.asList(Spells.FREEDOM_OF_MOVEMENT, Spells.ICE_STORM),
                            Arrays.asList(Spells.COMMUNE_WITH_NATURE, Spells.CONE_OF_COLD))).build(),
                    Table.builder().name("Coast")
                            .addColumn(MCDNDKeys.DRUID_LEVEL, DRUID_LEVELS)
                            .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.MIRROR_IMAGE, Spells.MISTY_STEP),
                                    Arrays.asList(Spells.WATER_BREATHING, Spells.WATER_WALK),
                                    Arrays.asList(Spells.CONTROL_WATER, Spells.FREEDOM_OF_MOVEMENT),
                                    Arrays.asList(Spells.CONJURE_ELEMENTAL, Spells.SCRYING))).build(),
                    Table.builder().name("Desert")
                            .addColumn(MCDNDKeys.DRUID_LEVEL, DRUID_LEVELS)
                            .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.BLUR, Spells.SILENCE),
                                    Arrays.asList(Spells.CREATE_FOOD_AND_WATER, Spells.PROTECTION_FROM_ENERGY),
                                    Arrays.asList(Spells.BLIGHT, Spells.HALLUCINATORY_TERRAIN),
                                    Arrays.asList(Spells.INSECT_PLAGUE, Spells.WALL_OF_STONE))).build(),
                    Table.builder().name("Forest")
                            .addColumn(MCDNDKeys.DRUID_LEVEL, DRUID_LEVELS)
                            .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.BARKSKIN, Spells.SPIDER_CLIMB),
                                    Arrays.asList(Spells.CALL_LIGHTNING, Spells.PLANT_GROWTH),
                                    Arrays.asList(Spells.DIVINATION, Spells.FREEDOM_OF_MOVEMENT),
                                    Arrays.asList(Spells.COMMUNE_WITH_NATURE, Spells.TREE_STRIDE))).build(),
                    Table.builder().name("Grassland")
                            .addColumn(MCDNDKeys.DRUID_LEVEL, DRUID_LEVELS)
                            .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.INVISIBILITY, Spells.PASS_WITHOUT_TRACE),
                                    Arrays.asList(Spells.DAYLIGHT, Spells.HASTE),
                                    Arrays.asList(Spells.DIVINATION, Spells.FREEDOM_OF_MOVEMENT),
                                    Arrays.asList(Spells.DREAM, Spells.INSECT_PLAGUE))).build(),
                    Table.builder().name("Mountain")
                            .addColumn(MCDNDKeys.DRUID_LEVEL, DRUID_LEVELS)
                            .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.SPIDER_CLIMB, Spells.SPIKE_GROWTH),
                                    Arrays.asList(Spells.LIGHTNING_BOLT, Spells.MELD_INTO_STONE),
                                    Arrays.asList(Spells.STONE_SHAPE, Spells.STONESKIN),
                                    Arrays.asList(Spells.PASSWALL, Spells.WALL_OF_STONE))).build(),
                    Table.builder().name("Swamp")
                            .addColumn(MCDNDKeys.DRUID_LEVEL, DRUID_LEVELS)
                            .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.DARKNESS, Spells.MELFS_ACID_ARROW),
                                    Arrays.asList(Spells.WATER_WALK, Spells.STINKING_CLOUD),
                                    Arrays.asList(Spells.FREEDOM_OF_MOVEMENT, Spells.LOCATE_CREATURE),
                                    Arrays.asList(Spells.INSECT_PLAGUE, Spells.SCRYING))).build(),
                    Table.builder().name("Underdark")
                            .addColumn(MCDNDKeys.DRUID_LEVEL, DRUID_LEVELS)
                            .addColumn(MCDNDKeys.CIRCLE_SPELLS, Arrays.asList(Arrays.asList(Spells.SPIDER_CLIMB, Spells.WEB),
                                    Arrays.asList(Spells.GASEOUS_FORM, Spells.STINKING_CLOUD),
                                    Arrays.asList(Spells.GREATER_INVISIBILITY, Spells.STONE_SHAPE),
                                    Arrays.asList(Spells.CLOUDKILL, Spells.INSECT_PLAGUE))).build())).build();
