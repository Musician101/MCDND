...
import io.musician101.mcdnd.sponge.clazz.feature.subclass.college.BardCollege;
import io.musician101.mcdnd.sponge.clazz.feature.subclass.domain.DivineDomain;
import io.musician101.mcdnd.sponge.clazz.feature.subclass.druidcircle.DruidCircle;
import io.musician101.mcdnd.sponge.clazz.feature.subclass.fightingstyle.FightingStyle;
import io.musician101.mcdnd.sponge.clazz.feature.subclass.primalpaths.PrimalPath;
import io.musician101.mcdnd.sponge.clazz.feature.subclass.primalpaths.totem.Totem;
import io.musician101.mcdnd.sponge.combat.Damage;
import io.musician101.mcdnd.sponge.combat.MCDNDDamageType;
import io.musician101.mcdnd.sponge.condition.Condition;
...
import io.musician101.mcdnd.sponge.equipment.gear.Gear;
import io.musician101.mcdnd.sponge.equipment.pack.Pack;
...
import io.musician101.mcdnd.sponge.language.Language;
import io.musician101.mcdnd.sponge.magic.Spell;
import io.musician101.mcdnd.sponge.magic.SpellComponents;
import io.musician101.mcdnd.sponge.magic.SpellDuration;
import io.musician101.mcdnd.sponge.magic.spelleffect.SpellEffect;
...
import io.musician101.mcdnd.sponge.shape.Cylinder;
...
import io.musician101.mcdnd.sponge.util.function.DoubleIntegerFunction;
import io.musician101.mcdnd.sponge.util.function.DualIntegerFunction;
import io.musician101.mcdnd.sponge.util.function.SpellLevelDiceFunction;
import io.musician101.mcdnd.sponge.util.function.SpellLevelIntegerFunction;
...
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeyFactory.makeListListKey;
...
public class MCDNDKeys
{
    ...
    public static final Key<Value<String>> ARCHERY_HANDLER = makeSingleKey(String.class, Value.class, of("ArcheryHandler"));
    ...
    public static final Key<Value<MCDNDArmorType>> ARMOR_TYPE = makeSingleKey(MCDNDArmorType.class, Value.class, of("ArmorType"));
    public static final Key<ListValue<MCDNDArmorType>> ARMOR_TYPES = makeListKey(MCDNDArmorType.class, of("ArmorTypes"));
    ...
    public static final Key<Value<DataContainer>> CHOICE_A = makeSingleKey(DataContainer.class, Value.class, of("A"));
    public static final Key<Value<DataContainer>> CHOICE_B = makeSingleKey(DataContainer.class, Value.class, of("B"));
    public static final Key<ListListValue<Spell>> CIRCLE_SPELLS = makeListListKey(Spell.class, of("CircleSpells"));
    ...
    public static final Key<Value<Cone>> CONE = makeSingleKey(Cone.class, Value.class, of("Cone"));
    ...
    public static final Key<Value<Cube>> CUBE = makeSingleKey(Cube.class, Value.class, of("Cube"));
    ...
    public static final Key<Value<Cylinder>> CYLINDER = makeSingleKey(Cylinder.class, Value.class, of("Cylinder"));
    ...
    public static final Key<Value<String>> DEFENSE_HANDLER = makeSingleKey(String.class, Value.class, of("DefenseHandler"));
    ...
    public static final Key<Value<String>> DUELING_HANDLER = makeSingleKey(String.class, Value.class, of("DuelingHandler"));
    ...
    public static final Key<MapValue<String, DataContainer>> EQUIPMENT_CHOICES = makeMapKey(String.class, DataContainer.class, of("EquipmentChoices"));
    ...
    public static final Key<Value<EquippedItems>> EQUIPPED_ITEMS = makeSingleKey(EquippedItems.class, Value.class, of("EquippedItems"));
    ...
    public static final Key<MapListValue<Integer, Feature>> FEATURES_MAP = makeMapListKey(Integer.class, Feature.class, of("FeaturesMap"));
    public static final Key<ListValue<FightingStyle>> FIGHTING_STYLES = makeListKey(FightingStyle.class, of("FightingStyles"));
    public static final Key<Value<Gear>> GEAR = makeSingleKey(Gear.class, Value.class, of("Gear"));
    public static final Key<Value<String>> GREAT_WEAPON_FIGHTING_HANDLER = makeSingleKey(String.class, Value.class, of("GreatWeaponFightingHandler"));
    ...
    public static final Key<Value<Line>> LINE = makeSingleKey(Line.class, Value.class, of("Line"));
    public static final Key<Value<Weapon>> MAIN_HAND = makeSingleKey(Weapon.class, Value.class, of("MainHand"));
    ...
    public static final Key<Value<Weapon>> OFF_HAND = makeSingleKey(Weapon.class, Value.class, of("OffHand"));
    public static final Key<Value<Pack>> PACK = makeSingleKey(Pack.class, Value.class, of("Pack"));
    ...
    public static final Key<Value<String>> PROTECTION_HANDLER = makeSingleKey(String.class, Value.class, of("ProtectionHandler"));
    ...
    public static final Key<ListValue<Spell>> SPELLS = makeListKey(Spell.class, of("Spells"));
    ...
    public static final Key<MapListValue<Integer, Spell>> SPElLS_MAP = makeMapListKey(Integer.class, Spell.class, of("SpellsMap"));
    ...
    public static final Key<Value<String>> TWO_WEAPON_FIGHTING_HANDLER = makeSingleKey(String.class, Value.class, of("TwoWeaponFightingHandler"));
    ...
    public static final Key<Value<Weapon>> WEAPON = makeSingleKey(Weapon.class, Value.class, of("Weapon"));
    public static final Key<ListValue<Weapon>> WEAPONS = makeListKey(Weapon.class, of("Weapons"));
    public static final Key<MapValue<Weapon, Integer>> WEAPON_INTEGER_MAP = makeMapKey(Weapon.class, Integer.class, of("WeaponIntegerMap"));
    public static final Key<ListMapValue<Weapon, Integer>> WEAPON_LIST_INTEGER_MAP = makeListMapKey(Weapon.class, Integer.class, of("WeaponListIntegerMap"));
