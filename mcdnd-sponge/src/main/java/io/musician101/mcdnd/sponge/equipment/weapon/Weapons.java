...
public class Weapons {
    ...
    public static List<Weapon> getMartialMeleeWeapons() {
        return Arrays.asList(BATTLEAXE, FLAIL, GLAIVE, GREATAXE, GREATSWORD, HALBERD, LANCE, LONGSWORD, MAUL, MORNINGSTAR, PIKE, RAPIER, SCIMITAR, SHORTSWORD, TRIDENT, WAR_PICK, WARHAMMER, WHIP);
    }
    ...
    public static List<Weapon> getSimpleMeleeWeapons() {
        return Arrays.asList(CLUB, DAGGER, GREATCLUB, HANDAXE, JAVELIN, LIGHT_HAMMER, MACE, QUARTERSTAFF, SICKLE, SPEAR, UNARMED_STRIKE);
    }
