...
public class PrimalPaths
{
    public static final PrimalPath BERSERKER = builder().name("Path of the Berserker")
            ...
            .addToMap(3, Collections.singletonList(BerserkerFeatures.FRENZY))
            .addToMap(6, Collections.singletonList(BerserkerFeatures.MINDLESS_RAGE))
            .addToMap(10, Collections.singletonList(BerserkerFeatures.INTIMIDATING_PRESENCE))
            .addToMap(14, Collections.singletonList(BerserkerFeatures.RETALIATION))
            .build();
    public static final PrimalPath TOTEM_WARRIOR = builder().name("Path of the Totem Warrior")
            ...
            .addToMap(3,Arrays.asList(TotemWarriorFeatures.SPIRIT_SEEKER, TotemWarriorFeatures.TOTEM_SPIRIT))
            .addToMap(6, Collections.singletonList(TotemWarriorFeatures.ASPECT_OF_THE_BEAST))
            .addToMap(10, Collections.singletonList(TotemWarriorFeatures.SPIRIT_WALKER))
            .addToMap(14, Collections.singletonList(TotemWarriorFeatures.TOTEMIC_ATTUNEMENT))
            .build();
