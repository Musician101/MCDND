...
public class DruidCircles
{
    public static final DruidCircle CIRCLE_OF_THE_LAND = builder().name("Circle of the Land")
            ...
            .addToMap(2, Arrays.asList(CircleOfTheLand.BONUS_CANTRIP, CircleOfTheLand.NATURAL_RECOVERY))
            .addToMap(3, Collections.singletonList(CircleOfTheLand.CIRCLE_SPELLS))
            .addToMap(6, Collections.singletonList(CircleOfTheLand.LANDS_STRIDE))
            .addToMap(10, Collections.singletonList(CircleOfTheLand.NATURES_WARD))
            .addToMap(14, Collections.singletonList(CircleOfTheLand.NATURES_SANCTUARY))
            .build();
    public static final DruidCircle CIRCLE_OF_THE_MOON = builder().name("Circle of the Moon")
            ...
            .addToMap(2, Arrays.asList(CircleOfTheMoon.COMBAT_WILD_SHAPE, CircleOfTheMoon.CIRCLE_FORMS))
            .addToMap(6, Collections.singletonList(CircleOfTheMoon.PRIMAL_STRIKE))
            .addToMap(10, Collections.singletonList(CircleOfTheMoon.ELEMENTAL_WILD_SHAPE))
            .addToMap(14, Collections.singletonList(CircleOfTheMoon.THOUSAND_FORMS))
            .build();
