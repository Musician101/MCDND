...
public class BardColleges
{
    public static final BardCollege LORE = builder().name("College of Lore").levelRequirement(3)
            ...
            .addToMap(3, Arrays.asList(LoreCollege.BONUS_PROFICIENCIES, LoreCollege.CUTTING_WORDS))
            .addToMap(6, Collections.singletonList(LoreCollege.ADDITIONAL_MAGICAL_SECRETS))
            .addToMap(14, Collections.singletonList(LoreCollege.PEERLESS_SKILL)).build();
    public static final BardCollege VALOR = builder().name("College of Valor").levelRequirement(3)
            ...
            .addToMap(3, Arrays.asList(ValorCollege.BONUS_PROFICIENCIES, ValorCollege.COMBAT_INSPIRATION))
            .addToMap(6, Collections.singletonList(ValorCollege.BARD_EXTRA_ATTACK))
            .addToMap(14, Collections.singletonList(ValorCollege.BATTLE_MAGIC)).build();
