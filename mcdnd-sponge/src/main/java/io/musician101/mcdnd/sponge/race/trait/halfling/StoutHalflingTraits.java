...
public class StoutHalflingTraits {
    ...
    public static final Trait STOUT_RESILIENCE = builder().name("Stout Resilience").addProperty(MCDNDKeys.DAMAGE_TYPE, MCDNDDamageTypes.POISON).description("You have advantage on saving throws against poison, and you have resistance against poison damage.").build();
