...
import io.musician101.mcdnd.sponge.condition.Conditions;
...
import io.musician101.mcdnd.sponge.magic.spelleffect.AlterSelfSpellEffects;
import io.musician101.mcdnd.sponge.magic.spelleffect.AntimagicFieldSpellEffects;
import io.musician101.mcdnd.sponge.magic.spelleffect.AntipathySympathySpellEffects;
import io.musician101.mcdnd.sponge.magic.spelleffect.ControlWaterSpellEffects;
import io.musician101.mcdnd.sponge.shape.Cone;
import io.musician101.mcdnd.sponge.shape.Cube;
import io.musician101.mcdnd.sponge.shape.Line;
import io.musician101.mcdnd.sponge.shape.Sphere;
import io.musician101.mcdnd.sponge.util.ActionTimes;
import io.musician101.mcdnd.sponge.util.table.Table;

import java.util.Arrays;

import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.ACID;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.BLUDGEONING;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.COLD;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.FIRE;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.FORCE;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.LIGHTNING;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.NECROTIC;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.PIERCING;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.POISON;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.PSYCHIC;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.RADIANT;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.SLASHING;
import static io.musician101.mcdnd.sponge.combat.MCDNDDamageTypes.THUNDER;
import static io.musician101.mcdnd.sponge.condition.Conditions.CHARMED;
import static io.musician101.mcdnd.sponge.condition.Conditions.DEAFENED;
import static io.musician101.mcdnd.sponge.condition.Conditions.PARALYZED;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.ABILITY_SCORE_TYPE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.ABILITY_SCORE_TYPES;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.AC_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.ARMOR_CLASS;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.ARMOR_CLASS_INCREASE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.ATTACK_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.CHARACTER_SIZE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.CONDITION;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.CONDITIONS;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.CONE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.CONNECTION_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.CUBE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DAMAGE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DAMAGE_TYPE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DAMAGE_TYPES;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DEPTH;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DEPTHS;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DEX_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DICE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DUAL_INTEGER_FUNCTION;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.DURATION;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.HEIGHT;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.HIT_POINTS;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.HP_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.INTEGER;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.INTEGER_DICE_MAP;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.INTEGER_MAP;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.INTEGER_STRING_MAP;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.KNOWLEDGE_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.LENGTH;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.LINE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.MAX_RANGE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.MIN_ROLL;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.MOVEMENT;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.MOVEMENT_INCREASE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.RANGE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SAVE_MODIFIER_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SAVING_THROW;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SIGHTS;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SIZE_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SKILL_TYPE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELLS;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELL_EFFECTS;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELL_LEVEL_DICE_MAP;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELL_LEVEL_DICE_MAP2;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELL_LEVEL_DOUBLE_MAP;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELL_LEVEL_DURATION_MAP;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELL_LEVEL_INTEGER_FUNCTION;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPELL_LEVEL_INTEGER_MAP;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.SPHERE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.STR_COLUMN;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.TABLE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.TABLES;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.VISIBILITY_RANGE;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.VOLUME;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.WEIGHT;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.WIDTH;
import static io.musician101.mcdnd.sponge.data.key.MCDNDKeys.WIDTHS;
import static io.musician101.mcdnd.sponge.data.type.AbilityScoreTypes.CONSTITUTION;
import static io.musician101.mcdnd.sponge.data.type.AbilityScoreTypes.DEXTERITY;
import static io.musician101.mcdnd.sponge.data.type.AbilityScoreTypes.INTELLIGENCE;
import static io.musician101.mcdnd.sponge.data.type.AbilityScoreTypes.STRENGTH;
import static io.musician101.mcdnd.sponge.data.type.AbilityScoreTypes.WISDOM;
import static io.musician101.mcdnd.sponge.data.type.CharacterSizes.MEDIUM;
import static io.musician101.mcdnd.sponge.data.type.skill.SkillTypes.INVESTIGATION;
import static io.musician101.mcdnd.sponge.data.type.skill.SkillTypes.PERCEPTION;
import static io.musician101.mcdnd.sponge.data.type.skill.SkillTypes.STEALTH;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.CANTRIP;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L1;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L2;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L3;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L4;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L5;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L6;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L7;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L8;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellLevels.L9;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellTypes.ABJURATION;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellTypes.CONJURATION;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellTypes.ENCHANTMENT;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellTypes.EVOCATION;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellTypes.ILLUSION;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellTypes.NECROMANCY;
import static io.musician101.mcdnd.sponge.data.type.spell.SpellTypes.TRANSMUTATION;
import static io.musician101.mcdnd.sponge.magic.Spell.builder;
import static io.musician101.mcdnd.sponge.util.ActionTimes.ACTION;
import static io.musician101.mcdnd.sponge.util.ActionTimes.BONUS_ACTION;
import static io.musician101.mcdnd.sponge.util.ActionTimes.EIGHT_HOURS;
import static io.musician101.mcdnd.sponge.util.ActionTimes.ONE_DAY;
import static io.musician101.mcdnd.sponge.util.ActionTimes.ONE_HOUR;
import static io.musician101.mcdnd.sponge.util.ActionTimes.ONE_MINUTE;
import static io.musician101.mcdnd.sponge.util.ActionTimes.REACTION;
import static io.musician101.mcdnd.sponge.util.ActionTimes.TEN_MINUTES;
import static io.musician101.mcdnd.sponge.util.MapUtils.populateSpellLevelDiceMap;
import static io.musician101.mcdnd.sponge.util.MapUtils.populateSpellLevelDoubleMap;
import static io.musician101.mcdnd.sponge.util.MapUtils.populateSpellLevelIntegerMap;
