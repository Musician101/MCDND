package io.musician101.sponge.mcdnd.data.value.immutable;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.Iterables;
import io.musician101.sponge.mcdnd.data.value.mutable.ListListValue;
...
public class ImmutableListListValue<E> implements ImmutableListValue<List<E>>
{
    ...
    {
        final ImmutableList.Builder<List<E>> builder = ImmutableList.builder();
        actualValue.stream().filter(list -> checkNotNull(predicate).test(list)).forEach(builder::add);//NOSONAR
        return new ImmutableListListValue<>(getKey(), builder.build());
    }
