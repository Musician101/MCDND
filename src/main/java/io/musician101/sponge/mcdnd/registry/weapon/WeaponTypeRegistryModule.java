...
public final class WeaponTypeRegistryModule implements CatalogRegistryModule<WeaponType>
{
    ...
    private final Map<String, WeaponType> mappings = new ImmutableMap.Builder<String, WeaponType>()
            .put(WeaponTypes.MARTIAL_MELEE.getId(), WeaponTypes.MARTIAL_MELEE)
            .put(WeaponTypes.MARTIAL_RANGED.getId(), WeaponTypes.MARTIAL_RANGED)
            .put(WeaponTypes.SIMPLE_MELEE.getId(), WeaponTypes.SIMPLE_MELEE)
            .put(WeaponTypes.SIMPLE_RANGED.getId(), WeaponTypes.SIMPLE_RANGED)
            .build();
