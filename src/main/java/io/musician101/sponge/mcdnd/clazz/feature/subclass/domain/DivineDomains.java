...
public class DivineDomains
{
    public static final DivineDomain KNOWLEDGE_DOMAIN = builder().name("Knowledge Domain")
            ...
            .addToMap(2, of(KnowledgeDomain.KNOWLEDGE_OF_THE_AGES))
            .addToMap(6, of(KnowledgeDomain.READ_THOUGHTS))
            .addToMap(8, of(KnowledgeDomain.POTENT_SPELLCASTING))
            .addToMap(17, of(KnowledgeDomain.VISIONS_OF_THE_PAST))
            .build();
    public static final DivineDomain LIFE_DOMAIN = builder().name("Life Domain")
            ...
            .addToMap(1, of(LifeDomain.DOMAIN_SPELLS, LifeDomain.BONUS_PROFICIENCY, LifeDomain.DISCIPLE_OF_LIFE))
            .addToMap(2, of(LifeDomain.PRESERVE_LIFE))
            .addToMap(6, of(LifeDomain.BLESSED_HEALER))
            .addToMap(8, of(LifeDomain.DIVINE_STRIKE))
            .addToMap(17, of(LifeDomain.SUPREME_HEALING))
            .build();
    public static final DivineDomain LIGHT_DOMAIN = builder().name("Light Domain")
            ...
            .addToMap(1, of(LightDomain.DOMAIN_SPELLS, LightDomain.BONUS_CANTRIP, LightDomain.WARDING_FLARE))
            .addToMap(2, of(LightDomain.RADIANCE_OF_THE_DAWN))
            .addToMap(6, of(LightDomain.IMPROVED_FLARE))
            .addToMap(8, of(LightDomain.POTENT_SPELLCASTING))
            .addToMap(17, of(LightDomain.CORONA_OF_LIGHT))
            .build();
    public static final DivineDomain NATURE_DOMAIN = builder().name("Nature Domain")
            ...
            .addToMap(1, of(NatureDomain.DOMAIN_SPELLS, NatureDomain.ACOLYTE_OF_NATURE, NatureDomain.BONUS_PROFICIENCY))
            .addToMap(2, of(NatureDomain.CHARM_ANIMALS_AND_PLANTS))
            .addToMap(6, of(NatureDomain.DAMPEN_ELEMENTS))
            .addToMap(8, of(NatureDomain.DIVINE_STRIKE))
            .addToMap(17, of(NatureDomain.MASTER_OF_NATURE))
            .build();
    public static final DivineDomain TEMPEST_DOMAIN = builder().name("Tempest Domain")
            ...
            .addToMap(1, of(TempestDomain.DOMAIN_SPELLS, TempestDomain.BONUS_PROFICIENCIES, TempestDomain.WRATH_OF_THE_STORM))
            .addToMap(2, of(TempestDomain.DESTRUCTIVE_WRATH))
            .addToMap(6, of(TempestDomain.THUNDERBOLT_STRIKE))
            .addToMap(8, of(TempestDomain.DIVINE_STRIKE))
            .addToMap(17, of(TempestDomain.STORMBORN))
            .build();
    public static final DivineDomain TRICKERY_DOMAIN = builder().name("Trickery Domain")
            ...
            .addToMap(1, of(TrickeryDomain.DOMAIN_SPELLS, TrickeryDomain.BLESSING_OF_THE_TRICKSTER))
            .addToMap(2, of(TrickeryDomain.INVOKE_DUPLICITY))
            .addToMap(6, of(TrickeryDomain.CLOAK_OF_SHADOWS))
            .addToMap(8, of(TrickeryDomain.DIVINE_STRIKE))
            .addToMap(17, of(TrickeryDomain.IMPROVED_DUPLICITY))
            .build();
    public static final DivineDomain WAR_DOMAIN = builder()
            ...
            .addToMap(1, of(WarDomain.DOMAIN_SPELLS, WarDomain.BONUS_PROFICIENCIES, WarDomain.WAR_PRIEST))
            .addToMap(2, of(WarDomain.GUIDED_STRIKE))
            .addToMap(6, of(WarDomain.WAR_GODS_BLESSING))
            .addToMap(8, of(WarDomain.DIVINE_STRIKE))
            .addToMap(17, of(WarDomain.AVATAR_OF_BATTLE))
            .build();
