...
public class ValorCollege
{
    ...
    public static final Feature COMBAT_INSPIRATION = builder().name("Combat Inspiration").levelRequirement(3)
            ...
            .build();
    public static final Feature BARD_EXTRA_ATTACK = builder().name("Extra Attack").levelRequirement(6)
            .description("Starting at 6th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.")
            .build();
    public static final Feature BATTLE_MAGIC = builder().name("Battle Magic").levelRequirement(14)
