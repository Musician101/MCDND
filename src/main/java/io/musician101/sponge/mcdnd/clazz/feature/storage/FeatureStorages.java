...
public class FeatureStorages
{
    ...
    public static final FeatureStorage BARBARIAN_FEATURES = new FeatureStorage(new CustomMap<Integer, List<Feature>>()
    ...
    public static final FeatureStorage BARD_FEATURES = new FeatureStorage(new CustomMap<Integer, List<Feature>>()
    ...
    public static final FeatureStorage CLERIC_FEATURES = new FeatureStorage(new CustomMap<Integer, List<Feature>>()
