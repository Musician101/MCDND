...
public class BardFeatures
{
    ...
    public static final Feature PROFICIENCIES = builder().name("Proficiencies").addProperty(MCDNDKeys.PROFICIENCIES, new ProficienciesProperty(Collections.singletonList(MCDNDArmorTypes.LIGHT), "Light armor",
    ...
    public static final Feature SPELLCASTING = builder().name("Spellcasting").description("You have learned to untangle and reshape the fabric of reality in harmony with your wishes and music. Your spells are part of your vast repertoire, magic that you can tune to different situations.")
            .addProperty(MCDNDKeys.SPELLS_KNOWN_SPELLCASTING_PROPERTY, new SpellsKnownSpellcastingProperty(builder().name("Cantrips")
                    ...
                    builder().name("Spell Slots")
                            .addLineToDescription("The Bard table shows how many spell slots you have to cast your spells of 1st level and higher. To cast one of these spells, you must expend a slot of the spell's level or higher. You regain all expended spell slots when you finish a long rest.")
                            .addLineToDescription("For example, if you know the 1st-level spell Cure Wounds and have a 1st-level and a 2nd-level spell slot available, you can cast cure wounds using either slot.")
                    ...
                    builder().name("Spells Known")
                            .addLineToDescription("You know four 1st-level spells of your choice from the bard spell list.")
                            .addLineToDescription("The Spells Known column of the Bard table shows when you learn more bard spells of your choice. Each of these spells must be of a level for which you have spell slots, as shown on the table. For instance, when you reach 3rd level in this class, you can learn on new spell of 1st or 2nd level.")
                            .addLineToDescription("Additionally, when you gain a level in this class, you can choose one of the bard spells you know and replace it with another spell from the bard spell list, which also must be of a level for which you have spell slots.")
                    ...
                    builder().name("Spellcasting Ability")
                            ...
                            .addLineToDescription("Spell save DC = 8 + your proficiency bonus + your Charisma modifier")
                            .addLineToDescription("Spell attack modifier = your proficiency bonus + your Charisma modifier")
    ...
    public static final Feature BARDIC_INSPIRATION = builder().name("Bardic Inspiration")
            .addLineToDescription("You can inspire others through stirring words or music. To do so, you use a bonus action on your turn to choose on creature other than yourself withing 60 feet of you who can hear you. That creature gains one Bardic Inspiration die, a d6.")
            .addLineToDescription("Once within the next 10 minutes, the creature can roll the die and add the number rolled to one ability check, attack roll, or saving throw it makes. The creature can wait until after it rolls the d20 before deciding to use the Bardic Inspiration die, but must decide before the DM says whether the roll succeeds or fails. Once the Bardic Inspiration die is rolled, it is lost. A creature can have only one Bardic Inspiration die at a time.")
            .addLineToDescription("You can use this feature a number of times equal to your Charisma modifier (a minimum of once). You regain any expended uses when you finish a long rest.")
            .addLineToDescription("Your bardic Inspiration die changes when you reach certain levels in this class. The die becomes a d8 at 5th level, a d10 at 10th level, and a d12 at 15th level.")
    ...
    public static final Feature SONG_OF_REST = builder().name("Song of Rest").levelRequirement(2)
            ...
            .addLineToDescription("The extra hit points increase when you reach certain levels in this class to 1d8 at 9th level, to 1d10 at 13th level, and to 1d12 at 17th level.")
    ...
    public static final Feature MAGICAL_SECRETS = builder().name("Magical Secrets").levelRequirement(10)
            .addLineToDescription("By 10th level, you have plundered magical knowledge from a wide spectrum of disciplines. Choose two spells from any class, including this one. A spell you choose must be of a level you can cast, as shown on the Bard table, or a cantrip.")
            .addLineToDescription("The chosen spells count as bard spells for you and are included in the Spells Known column of the Bard table.")
            .addLineToDescription("You learn two additional spells from any class at 14th level and again at 18th level.")
