...
public class DruidCircles
{
    public static final DruidCircle CIRCLE_OF_THE_LAND = builder().name("Circle of the Land")
            ...
            .addToMap(2, of(CircleOfTheWind.BONUS_CANTRIP, CircleOfTheWind.NATURAL_RECOVERY))
            .addToMap(3, of(CircleOfTheWind.CIRCLE_SPELLS))
            .addToMap(6, of(CircleOfTheWind.LANDS_STRIDE))
            .addToMap(10, of(CircleOfTheWind.NATURES_WARD))
            .addToMap(14, of(CircleOfTheWind.NATURES_SANCTUARY))
            .build();
