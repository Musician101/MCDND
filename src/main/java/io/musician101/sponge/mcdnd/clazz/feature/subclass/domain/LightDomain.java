...
public class LightDomain
{
    ...
    public static final Feature RADIANCE_OF_THE_DAWN = builder().name("Channel Divinity: Radiance of the Dawn").levelRequirement(2)
            .addLineToDescription("Starting at 2nd level, you can use your Channel Divinity to harness sunlight, banishing darkness and dealing radiant damage to your foes.")
