...
{
    public static final PrimalPath BERSERKER = ((PrimalPathBuilder) builder()).name("Path of the Berserker")
            ...
            .build();
    public static final PrimalPath TOTEM_WARRIOR = ((PrimalPathBuilder) builder()).name("Path of the Totem Warrior")
