...
public class PrimalPaths
{
    public static final PrimalPath BERSERKER = builder().name("Path of the Berserker")
            ...
            .addToMap(3, of(BerserkerFeatures.FRENZY))
            .addToMap(6, of(BerserkerFeatures.MINDLESS_RAGE))
            .addToMap(10, of(BerserkerFeatures.INTIMIDATING_PRESENCE))
            .addToMap(14, of(BerserkerFeatures.RETALIATION))
            .build();
    public static final PrimalPath TOTEM_WARRIOR = builder().name("Path of the Totem Warrior")
            ...
            .addToMap(3,of(TotemWarriorFeatures.SPIRIT_SEEKER, TotemWarriorFeatures.TOTEM_SPIRIT))
            .addToMap(6,of(TotemWarriorFeatures.ASPECT_OF_THE_BEAST))
            .addToMap(10,of(TotemWarriorFeatures.SPIRIT_WALKER))
            .addToMap(14,of(TotemWarriorFeatures.TOTEMIC_ATTUNEMENT))
            .build();
