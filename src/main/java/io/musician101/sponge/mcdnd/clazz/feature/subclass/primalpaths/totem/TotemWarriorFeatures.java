...
{
    public static final Feature SPIRIT_SEEKER = builder().name("Spirit Seeker").levelRequirement(3)
            ...
            .addProperty(MCDNDKeys.SPELL_LIST, SpellList.of(Arrays.asList(Spells.BEAST_SENSE, Spells.SPEAK_WITH_ANIMALS))).build();
    public static final Feature TOTEM_SPIRIT = builder().name("Totem Spirit").levelRequirement(3)
            ...
            .addProperty(MCDNDKeys.TOTEM_LIST, Totems.ALL_TOTEMS.get(3)).build();
    public static final Feature ASPECT_OF_THE_BEAST = builder().name("Aspect of the Beast").levelRequirement(6)
            ...
            .addProperty(MCDNDKeys.TOTEM_LIST, Totems.ALL_TOTEMS.get(6)).build();
    public static final Feature SPIRIT_WALKER = builder().name("Spirit Walker").levelRequirement(10)
            ...
            .addProperty(MCDNDKeys.SPELL, Spells.COMMUNE_WITH_NATURE).build();
    public static final Feature TOTEMIC_ATTUNEMENT = builder().name("Totemic Attunement").levelRequirement(14)
            ...
            .addProperty(MCDNDKeys.TOTEM_LIST, Totems.ALL_TOTEMS.get(14)).build();
