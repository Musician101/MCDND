...
public class KnowledgeDomain
{
    ...
    public static final Feature READ_THOUGHTS = builder().name("Channel Divinity: Read Thoughts").levelRequirement(6)
            .addLineToDescription("At 6th level, you can use your Channel Divinity to read a creature's thoughts. You can then use your access to the creature's mind to command it.")
            .addLineToDescription("As an action, choose one creature that you can see within 60 feet of you. That creature must make a Wisdom saving throw. If the creature succeeds on the saving throw, you can't use this feature on it again until you finish a long rest.")
            .addLineToDescription("If the creature fails its save, you can read its surface thoughts (those foremost in its mind, reflecting its current emotions and what it is actively thinking about) when it is within 60 feet of you. This effect lasts for 1 minute.")
            .addLineToDescription("During that time, you can use your action to end this effect and cast the Suggestion spell on the creature without expending a spell slot. The target automatically fails its saving throw against the spell.")
            .build();
    public static final Feature POTENT_SPELLCASTING = builder().name("Potent Spellcasting").levelRequirement(8)
            ...
            .addProperty(MCDNDKeys.ABILITY_SCORE_TYPE, AbilityScoreTypes.WISDOM).addProperty(MCDNDKeys.SPELL_LEVEL, SpellLevels.CANTRIP).build();
    public static final Feature VISIONS_OF_THE_PAST = builder().name("Visions of the Past").levelRequirement(17)
            ...
            .addLineToDescription("Once you use this feature, you can't use it again until you finish a short or a long rest.")
