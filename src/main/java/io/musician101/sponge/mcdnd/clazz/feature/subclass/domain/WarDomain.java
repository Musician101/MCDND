...
public class WarDomain
{
    ...
    public static final Feature WAR_PRIEST = builder().name("War Priest")
            ...
            .build();
    public static final Feature GUIDED_STRIKE = builder().name("Channel Divinity: Guided Strike").levelRequirement(2)
            ...
            .build();
    public static final Feature WAR_GODS_BLESSING = builder().name("Channel Divinity: War God's Blessing").levelRequirement(6)
    ...
    public static final Feature DIVINE_STRIKE = builder().name("Divine Strike").levelRequirement(8)
            ...
            .addProperty(MCDNDKeys.INTEGER_DICE_MAP, ImmutableMap.<Integer, Dice>builder()
                    ...
                    .build()).build();
    public static final Feature AVATAR_OF_BATTLE = builder().name("Avatar of Battle").levelRequirement(17)
