...
import io.musician101.sponge.mcdnd.equipment.gear.Gear.DruidicFocusGear;
...
public class AdventuringGear
{
    ...
    public static final Gear ARROWS = new AmmunitionGear("Arrows", 20, new Cost(CurrencyTypes.GOLD, 1), 1);
    public static final Gear BLOWGUN_NEEDLES = new AmmunitionGear("Blowgun Needles", 50, new Cost(CurrencyTypes.GOLD, 1), 1);
    public static final Gear CROSSBOW_BOLTS = new AmmunitionGear("Crossbow Bolts", 20, new Cost(CurrencyTypes.GOLD, 1), 1.5);
    public static final Gear SLING_BULLETS = new AmmunitionGear("Sling Bullets", 20, new Cost(CurrencyTypes.COPPER, 4), 1.5);
    ...
    public static final Gear BALL_BEARINGS = new BundledGear("Ball Bearings (bag of 1,000)", 1000, new Cost(CurrencyTypes.GOLD, 1), 2);
    ...
    public static final Gear CALTROPS = new BundledGear("Caltrops (bag of 20)", 20, new Cost(CurrencyTypes.GOLD, 1), 2);
    ...
    public static final Gear CHAIN = new BundledGear("Chain (10 feet)", 10, new Cost(CurrencyTypes.GOLD, 5), 10);
    public static final Gear CHALK = new BundledGear("Chalk (1 piece)", 1, new Cost(CurrencyTypes.COPPER, 1), 0);
    ...
    public static final Gear LADDER = new BundledGear("Ladder", 10, new Cost(CurrencyTypes.SILVER, 1), 25);
    ...
    public static final Gear POLE = new BundledGear("Pole", 10, new Cost(CurrencyTypes.COPPER, 5), 7);
    ...
    public static final Gear ROPE_HEMPEN = new BundledGear("Hempen Rope", 50, new Cost(CurrencyTypes.GOLD, 1), 10);
    public static final Gear ROPE_SILK = new BundledGear("Silk Rope", 50, new Cost(CurrencyTypes.GOLD, 10), 5);
    ...
    public static final Gear SPIKES_IRON = new BundledGear("Iron Spikes", 10, new Cost(CurrencyTypes.GOLD, 1), 5);
    public static final Gear SPYGLASS = new Gear("Spyglass", new Cost(CurrencyTypes.GOLD, 1000), 1);
    public static final Gear STRING = new BundledGear("String", 10, new Cost(CurrencyTypes.GOLD, 0), 0);
