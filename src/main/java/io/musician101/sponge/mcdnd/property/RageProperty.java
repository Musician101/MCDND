...
{
    private final Map<Integer, Integer> rageDamageMap = new CustomMap<Integer, Integer>().add(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8), 2)
            .add(Arrays.asList(9, 10, 11, 12, 13, 14, 15), 3).add(Arrays.asList(16, 17, 18, 19, 20), 4);
    private final Map<Integer, Integer> ragesMap = new CustomMap<Integer, Integer>().add(Arrays.asList(1,2) , 2)
