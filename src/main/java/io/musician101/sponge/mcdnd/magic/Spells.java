...
import io.musician101.sponge.mcdnd.magic.spelleffect.SpellEffects.ControlWaterSpellEffects;
import io.musician101.sponge.mcdnd.property.list.ListProperty;
import io.musician101.sponge.mcdnd.property.list.ListProperty.MultipleEffectsProperty;
import io.musician101.sponge.mcdnd.property.map.MappedProperty;
import io.musician101.sponge.mcdnd.property.map.MappedProperty.SpellLevelProperty.SpellLevelDiceProperty;
import io.musician101.sponge.mcdnd.property.map.MappedProperty.SpellLevelProperty.SpellLevelDoubleProperty;
import io.musician101.sponge.mcdnd.property.map.MappedProperty.SpellLevelProperty.SpellLevelIntegerProperty;
import io.musician101.sponge.mcdnd.property.map.ScalableDamageProperty.IntegerScalableDamageProperty;
import io.musician101.sponge.mcdnd.property.map.ScalableDamageProperty.SpellLevelScalableDamageProperty;
import io.musician101.sponge.mcdnd.property.single.SingleValueProperty;
import io.musician101.sponge.mcdnd.property.single.SingleValueProperty.AbilityScoreDCSaveProperty;
import io.musician101.sponge.mcdnd.property.single.SingleValueProperty.DamageTypeProperty;
import io.musician101.sponge.mcdnd.property.single.SingleValueProperty.SkillDCSaveProperty;
    ...
    {
        {
            ...
            properties = Collections.singletonList(new MappedProperty<>(getId(), CustomMap.populateSpellLevelIntegerMap(spellLevel, level -> 5 * (level.getValue() - 1))));
        }
    };
    ...
    {
        {
            ...
            properties = Arrays.asList(new SpellLevelIntegerProperty(getId(), CustomMap.populateSpellLevelIntegerMap(spellLevel, SpellLevel::getValue)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.WISDOM));
        }
    };
    ...
    {
        {
            ...
            properties = Arrays.asList(new SpellLevelDiceProperty(getId(), CustomMap.populateSpellLevelDiceMap(spellLevel, 10, level -> level.getValue() - 1)), new DamageTypeProperty(getId(), DamageTypes.LIGHTNING), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
        }
    };
    ...
    {
        {
            ...
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.FIRE, CustomMap.populateSpellLevelDiceMap(spellLevel, 6, level -> level.getValue() + 5)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
        }
    };
    ...
    {
        {
            ...
            properties = Arrays.asList(new SpellLevelDiceProperty(getId(), CustomMap.populateSpellLevelDiceMap(spellLevel, 6, level -> level.getValue() - 1)), new ListProperty<>(getId() + ".property.list.damage_type", Arrays.asList(DamageTypes.FIRE, DamageTypes.RADIANT)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
        }
    };
    ...
    {
        {
            ...
            spellDuration = SpellDuration.of(60, true);
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.FIRE, CustomMap.populateSpellLevelDiceMap(spellLevel, 6, SpellLevel::getValue)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
        }
    };
    ...
    {
        {
            ...
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.BLUDGEONING, CustomMap.populateSpellLevelDiceMap(spellLevel, 8, level -> level.getValue() - 2)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
        }
    };
    ...
    {
        {
            ...
            spellDuration = SpellDuration.of(600, true);
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.PIERCING, CustomMap.populateSpellLevelDiceMap(spellLevel, 10, level -> level.getValue() - 1)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.CONSTITUTION));
        }
    };
    ...
    {
        {
            ...
            spellDuration = SpellDuration.of(600, true);
            properties = Arrays.asList(new MappedProperty<>(getId() + ".property.map.connection", new CustomMap<String, Integer>().add("Likeness", -2).add("Possession", -4).add("Body part", -10)), new MappedProperty<>(getId() + ".property.map.knowledge", new CustomMap<String, Integer>().add("Secondhand", 5).add("Firsthand", 0).add("Familiar", -5)));
        }
    };
    ...
    {
        {
            ...
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.THUNDER, CustomMap.populateSpellLevelDiceMap(spellLevel, 8, level -> level.getValue() + 1)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.CONSTITUTION));
        }
    };
    ...
    {
        {
            ...
            spellDuration = SpellDuration.of(60, true);
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.FIRE, CustomMap.populateSpellLevelDiceMap(spellLevel, 8, level -> level.getValue() + 1)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
        }
    };
