...
import io.musician101.sponge.mcdnd.magic.spelleffect.SpellEffects.AlterSpellEffects;
import io.musician101.sponge.mcdnd.magic.spelleffect.SpellEffects.AntimagicFieldSpellEffects;
import io.musician101.sponge.mcdnd.magic.spelleffect.SpellEffects.AntipathySympathySpellEffects;
import io.musician101.sponge.mcdnd.property.list.ListProperty;
import io.musician101.sponge.mcdnd.property.map.MappedProperty;
...
import static io.musician101.sponge.mcdnd.data.type.spell.SpellLevels.ALL;
...
public class Spells
{
    public static final Spell ACID_SPLASH = builder().name("Acid Splash")
            ...
            .addProperty(MCDNDKeys.SAVING_THROW, AbilityScoreTypes.DEXTERITY).addProperty(MCDNDKeys.DAMAGE_TYPE, DamageTypes.ACID)
    ...
    public static final Spell AID = builder().name("Aid")
            ...
            .addProperty(MCDNDKeys.SPELL_LEVEL_INTEGER_MAP, MapUtils.populateSpellLevelIntegerMap(L2, level -> 5 * (level.getValue() - 1)))
            .build();
    ...
    public static final Spell ALTER_SELF = builder().name("Alter Self")
            ...
            .addProperty(MCDNDKeys.SPELL_EFFECTS, Arrays.asList(AlterSpellEffects.AQUATIC_ADAPTATION, AlterSpellEffects.CHANGE_APPEARANCE, AlterSpellEffects.NATURAL_WEAPONS))
            .build();
    public static final Spell ANIMAL_FRIENDSHIP = builder().name("Animal Friendship")
            ...
            .addProperty(MCDNDKeys.SPELL_LEVEL_INTEGER_MAP, MapUtils.populateSpellLevelIntegerMap(L2, SpellLevel::getValue))
            .addProperty(MCDNDKeys.SAVING_THROW, AbilityScoreTypes.WISDOM)
            .build();
    public static final Spell ANIMAL_MESSENGER = builder().name("Animal Messenger")
            ...
            .addProperty(MCDNDKeys.SPELL_LEVEL_DOUBLE_MAP, MapUtils.populateSpellLevelDoubleMap(L2, level -> ActionTimes.ONE_DAY + (level.getValue() - 2) * ActionTimes.TWO_DAYS))
            .build();
    ...
    public static final Spell ANIMATE_DEAD = builder().name("Animate Dead")
            ...
            .addProperty(MCDNDKeys.SPELL_LEVEL_INTEGER_MAP, MapUtils.populateSpellLevelIntegerMap(L3, level -> level.getValue() - 2))
            .build();
    public static final Spell ANIMATE_OBJECTS = builder().name("Animate Objects")
            ...
            .addProperty(MCDNDKeys.SPELL_LEVEL_INTEGER_MAP, MapUtils.populateSpellLevelIntegerMap(L5, level -> level.getValue() * 2))
            .addProperty(MCDNDKeys.TABLE, Table.builder().name("Animated Object Statistics")
                    .addColumn(MCDNDKeys.SIZE_COLUMN, Arrays.asList(CharacterSize.TINY, CharacterSize.SMALL, CharacterSize.MEDIUM, CharacterSize.LARGE, CharacterSize.HUGE))
                    .addColumn(MCDNDKeys.HP_COLUMN, Arrays.asList(20, 25, 40, 50, 80)).addColumn(MCDNDKeys.AC_COLUMN, Arrays.asList(18, 16, 13, 10, 10))
                    .addColumn(MCDNDKeys.ATTACK_COLUMN, Arrays.asList("+8 to hit, 1d4 + 4 damage", "+6 to hit, 1d8 + 2 damage", "+5 to hit, 2d6 + 1 damage", "+6 to hit, 2d10 + 2 damage", "+8 to hit, 2d12 + 4 damage"))
                    .addColumn(MCDNDKeys.STR_COLUMN, Arrays.asList(4, 6, 10, 14, 18)).addColumn(MCDNDKeys.DEX_COLUMN, Arrays.asList(18, 14, 12, 10, 6))
                    .build()).build();
    ...
    public static final Spell ANTIMAGIC_FILED = builder().name("Antimagic Field")
            ...
            .duration(SpellDuration.of(ActionTimes.ONE_HOUR, true))
            .addProperty(MCDNDKeys.SPELL_EFFECTS, AntimagicFieldSpellEffects.ALL)
            .build();
    public static final Spell ANTIPATHY_SYMPATHY = builder().name("Antipathy/Sympathy")
            ...
            .addProperty(MCDNDKeys.SPELL_EFFECTS, AntipathySympathySpellEffects.ALL)
            .build();
    ...
    public static final Spell AURA_OF_LIFE = builder().name("aura_of_life", "Aura of Life", "Life-preserving energy radiates from you in an aura with a 30-foot radius. Until the spell ends, the aura moves with you, centered on you. Each nonhostile creature in the aura (including you) has resistance to necrotic damage, and its hit point maximum can't be reduced. In addition, a nonhostile, living creature regains 1 hit point when it starts its turn in the aura with 0 hit points.")
            .castingTime(ActionTimes.ACTION;
    ...
    public static final Spell AURA_OF_PURITY = builder().name("aura_of_purity", "Aura of Purity", "Purifying energy radiates from you in an aura with a 30-foot radius. Until the spell ends, the aura moves with you, centered on you. Each nonhostile creature in the aura (including you) can't become diseased, has resistance to poison damage, and has advantage on saving throws against effects that cause any of the following conditions: blinded, charmed, deafened, frightened, paralyzed, poisoned, and stunned.")
            .type(ABJURATION;
            .level(L4;
            .components(SpellComponents.of(true, false);
            .duration(SpellDuration.of(ActionTimes.ONE_MINUTE * 10, true);
    ...
    public static final Spell BARKSKIN = builder().name("barkskin", "Barkskin", "You touch a willing creature. Until the spell ends, the target's skin has a rough, bark-like appearance, and the target's AC can't be less than 16, regardless of what kind of armor it is wearing.")
            .type(TRANSMUTATION;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
            .components(SpellComponents.of(true, true, "a handful of oak bark");
            .duration(SpellDuration.of(ActionTimes.ONE_HOUR, true);
    public static final Spell BEACON_OF_HOPE = builder().name("beacon_of_hope", "Beacon of Hope", "This spell bestows hope and vitality. Choose any number of creatures within range. For the duration, each target has advantage on Wisdom saving throws and death saving throws, and regains the maximum number of hit points possible from any healing.")
            .type(ABJURATION;
            .level(L3;
            .castingTime(ActionTimes.ACTION;
            .range(30;
    ...
    public static final Spell BEAST_SENSE = builder().name("beast_sense", "Beast Sense", "You touch a willing beast. For the duration of the spell, you can use your action to see through the beast's eyes and hear what it hears, and continue to do so until you use your action to return to your normal senses.", "While perceiving through the beast's senses, you gain the benefits of any special senses possessed by that creature, though you are blinded and deafened to your own surroundings.")
            .isRitual(true;
            .type(DIVINATION;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
    ...
    public static final Spell CURE_WOUNDS = builder().name("cure_wounds", "Cure Wounds", "A creature you touch regains a number of hit points equal to 1d8 + your spellcasting ability modifier. This spell has no effect on undead or constructs.", "At Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, the healing increases by 1d8 for each slot level above 1st.")
            .type(EVOCATION;
            .level(L1;
            .castingTime(ActionTimes.ACTION;
            .components(SpellComponents.of(true, true);
    ...
    public static final Spell DANCING_LIGHTS = builder().name("dancing_lights", "Dancing Lights", "You create up to four torch-sized lights within range, making them appear as torches, lanterns, or glowing orbs that hover in the air for the duration. You can also combine the four lights into one glowing vaguely humanoid form of Medium size. Whichever form you choose, each light sheds dim light in a 10-foot radius.", "As a Bonus action on your turn, you can move the lights up to 60 feet to a new spot within range. A light must be within 20 feet of anther light created by this spell, and a light winks out if it exceeds the spell's range.")
            ...
            .duration(SpellDuration.of(60, true);
    public static final Spell DARKNESS = builder().name("darkness", "Darkness", "Magical darkness spreads from a point you choose within range to fill a 15-foot-radius sphere for the duration. The darkness spreads around corners. A creature with darkvision can't see through this darkness, and nonmagical light can't illuminate it.", "If the point you choose is on an object you are holding or one that isn't being worn or carried, the darkness emanates from the object and moves with it. Completely covering the source of the darkness with an opaque object, such as a bowl or a helm, blocks the darkness.", "If any of this spell's are overlaps with an area of light created by a spell of 2nd level or lower, the spell that created the light is dispelled.")
            .type(EVOCATION;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
            .range(60;
            ...
            .duration(SpellDuration.of(600, true);
    public static final Spell DAYLIGHT = builder().name("daylight", "Daylight", "A 60-foot-radius sphere of light spreads out from a point you choose within range. The sphere is bright light and sheds dim light for an additional 60 feet.", "If you chose a point on an object you are holding or one that isn't being worn or carried, the light shines from the object and moves with it. Completely covering the affected object with an opaque object, such as a bowl, or a helm, blocks the light.", "if any of this spell's area overlaps with an area of darkness created by a spell of 3rd level or lower, the spell that created the darkness is dispelled.")
            .type(EVOCATION;
            .level(L3;
            .castingTime(ActionTimes.ACTION;
            .range(60;
    ...
    public static final Spell DOMINATE_BEAST = builder().name("dominate_beast", "Dominate Beast", "You attempt to beguile a beast that you can see within range. It must succeed on a Wisdom saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are fighting it, it has advantage on the saving throw.", "While the beast is charmed, you have a telepathic link with it as long as the two of you are on the same plane of existence. You can use this telepathic link to issue commands to the creature while you are conscious (no action required), which it does its best to obey. You can specify a simple and general course of action, such as \"Attack that creature,\" \"Run over there,\", or \"Fetch that object.\" If the creature completes the order and doesn't receive further direction from you, it defends and preserves itself to the best of its ability.", "You can use your action to take total and precise control of the target. until the end of your next turn, the creature takes only the actions you choose, and doesn't do anything that you don't allow it to do. During this time, you can also cause the creature to use a reaction, but this requires you to use your own reaction as well.", "Each time the target takes damage, it makes a new Wisdom saving throw against the spell. If the saving throw succeeds, the spell ends.", "At Higher Levels: When you cast this spell with a 5th-level spell slot, the duration is concentration, up to 10 minutes. When you use a 6th-level spell slot, the duration is concentration, up to 1hour. When you use a spell slot of 7th level or higher, the duration is concentration, up to 8 hours.")
            ...
            properties = Collections.singletonList(new SpellLevelIntegerProperty(getId(), new MapUtils<SpellLevel, Integer>().add(L4, 60).add(L5, 600).add(L6, 3600).add(Arrays.asList(L7, L8, L9), 28800)));
    public static final Spell FAERIE_FIRE = builder().name("faerie_fire", "Faerie Fire", "Each object in a 20-foot cube within range is outlined in blue, green, or violet light (your choice). Any creature in the area when the spell is cast is also outlined in light if it fails a Dexterity saving throw. For the duration, objects and affected creatures shed dim light in a 10-foot radius.", "Any attack roll against an affected creature or object has advantage if the attacker can see it, and the affected creature or object can't benefit from being invisible.")
            .type(EVOCATION;
            .level(L1;
            .castingTime(ActionTimes.ACTION;
            .range(60;
            .duration(SpellDuration.of(60, true);
            properties = Collections.singletonList(new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
    public static final Spell FIREBALL = builder().name("fireball", "Fireball", "A bright streak flashes from your pointing finger to a point you choose within range and then blossoms with a low roar into an explosion of flame. Each creature in a 20-foot-radius sphere centered on that point must make a Dexterity saving throw. A target takes 8d6 fire damage on a failed save, or half as much damage on a successful one.", "The fire spreads around corners. It ignites flammable objects in the area that aren't being worn or carried.", "At Higher Levels: When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd.")
            .type(EVOCATION;
            .level(L3;
            .castingTime(ActionTimes.ACTION;
            .range(150;
            .components(SpellComponents.of(true, true, "a tiny ball of bat guano and sulfur");
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.FIRE, MapUtils.populateSpellLevelDiceMap(spellLevel, 6, level -> level.getValue() + 5)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
    public static final Spell FLAME_STRIKE = builder().name("flame_strike", "Flame Strike", "A vertical column of divine fire roars down from the heavens in a location you specify. Each creature in a 10-foot-radius, 40-foot-high cylinder centered on a point within range must make a Dexterity saving throw. A creature takes 4d6 fire damage and 4d6 radiant damage on a failed save, or half as much damage on a successful one.", "At Higher Levels: When you cast this spell using a spell slot of 6th level or higher, the fire damage or the radiant damage (your choice) increases by 1d6 for each slot level above 5th.")
            .type(EVOCATION;
            .level(L5;
            .castingTime(ActionTimes.ACTION;
            .range(60;
            .components(SpellComponents.of(true, true, "pinch of sulfur");
            properties = Arrays.asList(new SpellLevelDiceProperty(getId(), MapUtils.populateSpellLevelDiceMap(spellLevel, 6, level -> level.getValue() - 1)), new ListProperty<>(getId() + ".property.list.damage_type", Arrays.asList(DamageTypes.FIRE, DamageTypes.RADIANT)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
    public static final Spell FLAMING_SPHERE = builder().name("flaming_sphere", "Flaming Sphere", "A 5-foot-diameter sphere of fire appears in an unoccupied space of your choice within range and lasts for the duration. Any creature that ends its turn within 5 feet of the sphere must make a Dexterity saving throw. The creature takes 2d6 fire damage on a failed save, or half as much damage on a successful one.", "As a bonus action, you can move the sphere up to 30 feet. If you ram the sphere into a creature, that creature must take make the saving throw against the sphere's damage, and the sphere stops moving this turn.", "When you move the sphere, you can direct it over barriers up to 5 feet tall and jump it across pits up to 10 feet wide. The sphere ignites flammable objects not being worn or carried, and it sheds bright light in a 20-foot radius and dim light for an additional 20 feet.", "At Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d6 for each slot level above 2nd.")
            .type(CONJURATION;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
            .range(60;
            ...
            .duration(SpellDuration.of(60, true);
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.FIRE, MapUtils.populateSpellLevelDiceMap(spellLevel, 6, SpellLevel::getValue)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
    public static final Spell FOG_CLOUD = builder().name("fog_cloud", "Fog Cloud", "You create a 20-foot-radius sphere of fog centered on a point within range. the sphere spreads around corners, and it's area is heavily obscured. It lasts for the duration or until a wind of moderate or greater speed (at least 10 miles per hour) disperses it.", "At Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, the radius of the fog increases by 20 feet for each slot level above 1st.")
            .type(CONJURATION;
            .level(L1;
            .castingTime(ActionTimes.ACTION;
            .range(120;
    ...
    public static final Spell LESSER_RESTORATION = builder().name("lesser_restoration", "Lesser Restoration", "You touch a creature and can end either one disease or one condition afflicting it. The condition can be blinded, deafened, paralyzed, or poisoned.")
            .type(ABJURATION;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
            .components(SpellComponents.of(true, true);
    public static final Spell LIGHT = builder().name("light", "Light", "You touch one object that is no larger than 10 feet in any dimension. Until the spell ends, the object sheds bright light in a 20-foot radius and dim light for an additional 20 feet. The light can be colored as you like. Completely covering the object with something opaque blocks the light. The spell ends if you cast it again or dismiss it as an action.", "If you target an object held or worn by a hostile creature, that creature must succeed on a Dexterity saving throw to avoid the spell.")
            .type(EVOCATION;
            .level(CANTRIP;
            .castingTime(ActionTimes.ACTION;
            ...
            .duration(SpellDuration.of(ActionTimes.ONE_HOUR);
            properties = Collections.singletonList(new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.DEXTERITY));
    public static final Spell MASS_CURE_WOUNDS = builder().name("mass_cure_wounds", "Mass Cure Wounds", "A wave of healing energy washes out from a point of your choice within range. Choose up to six creatures in a 30-foot-radius sphere centered on that point. Each target regains hit points equal to 3d8 + your spellcasting ability modifier. This spell has no effect on undead or constructs.", "At Higher Levels: When you cast this spell using a spell slot of 6th level or higher, the healing increases by 1d8 for each slot level above 5th.")
            .type(CONJURATION;
            .level(L5;
            .castingTime(ActionTimes.ACTION;
            .range(60;
            .components(SpellComponents.of(true, true);
            properties = Collections.singletonList(new SpellLevelIntegerProperty(getId(), MapUtils.populateSpellLevelIntegerMap(spellLevel, level -> level.getValue() - 2)));
    public static final Spell MINOR_ILLUSION = builder().name("minor_illusion", "Minor Illusion", "You create a sound or an image of an object within range that lasts for the duration. The illusion also ends if you dismiss it as an action or cast this spell again.", "If you create a sound, its volume can range from a whisper to a scream. It can be your voice, someone else's voice, a lion's roar, a beating of drums, or any other sound you choose. The sound continues unabated thought the duration, or you can make discrete sounds at different times before the spell ends.", "If you create an image of an object-such as a chair, muddy footprints, or a small chest-it must be no larger than a 5-foot cube. The image can't create sound, light, smell, or any other sensory effect. Physical interaction with the image reveals it to be an illusion, because things can pass through it.", "If a creature uses its action to examine the sound or image, the creature can determine that it is an illusion with a successful Intelligence (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the illusion becomes faint to the creature.")
            .type(ILLUSION;
            .level(CANTRIP;
            .castingTime(ActionTimes.ACTION;
            .range(30;
    ...
    public static final Spell SCRYING = builder().name("scrying", "Scrying", "You can see and hear a particular creature you choose that is on the same plane of existence as you. The target must make a Wisdom saving throw, which is modified by how well you know the target and the sort of physical connection you have to it. If a target knows you're casting this spell, it can fail the saving throw voluntarily if it wants to be observed.", "On a successful save, the target isn't affected, and you can't use this spell against it again for 24 hours.", "On a failed save, the spell creates an invisible sensor within 10 feet of the target. You can see and hear through the sensor as if you were there. The sensor moves with the target, remaining within 10 feet of it for the duration. A creature that can see invisible objects sees the sensor as a luminous orb about the size of your fist.", "Instead of targeting a creature, you can choose a location you have seen before as the target of this spell. When you do, the sensor appears at that location and doesn't move.")
            ...
            .duration(SpellDuration.of(600, true);
            properties = Arrays.asList(new MappedProperty<>(getId() + ".property.map.connection", new MapUtils<String, Integer>().add("Likeness", -2).add("Possession", -4).add("Body part", -10)), new MappedProperty<>(getId() + ".property.map.knowledge", new MapUtils<String, Integer>().add("Secondhand", 5).add("Firsthand", 0).add("Familiar", -5)));
    public static final Spell SHATTER = builder().name("shatter", "Shatter", "A sudden loud ringing noise, painfully intense, erupts from a point of your choice within range. Each creature in a 10-foot-radius sphere centered on that point must make a Constitution saving throw. A creature takes 3d8 thunder damage on a failed save, or half as much damage on a successful one. Acreature made of inorganic material such as stone, crystal, or metal has disadvantage on this saving throw.", "A nonmagical object that isn't being worn or carried also takes the damage if it's in the spell's area.", "At Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for each slot level above 2nd.")
            .type(EVOCATION;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
            .range(60;
            .components(SpellComponents.of(true, true, "a chip of mica");
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.THUNDER, MapUtils.populateSpellLevelDiceMap(spellLevel, 8, level -> level.getValue() + 1)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.CONSTITUTION));
    public static final Spell SLEET_STORM = builder().name("sleet_storm", "Sleet Storm", "Until the spell ends, freezing rain and sleet fall in a 20-foot-tall cylinder with a 40-foot radius centered on a point you choose within range. The area is heavily obscured, and exposed flames in the area are doused.", "The ground in the area is covered with slick ice, making it difficult terrain. When a creature enters the spell's area for the first time on a turn or starts its turn there, it makes a Dexterity saving throw. On a failed save, it falls prone.", "If a creature is concentrating in the spell's area, the creature must make a successful Constitution saving throw against your spell save DC or lose concentration.")
            .type(CONJURATION;
            .level(L3;
            .castingTime(ActionTimes.ACTION;
            .range(150;
            .components(SpellComponents.of(true, true, "a pinch of dust and a few drops of water");
            .duration(SpellDuration.of(60, true);
            properties = Collections.singletonList(new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.CONSTITUTION));
    public static final Spell SPEAK_WITH_ANIMALS = builder().name("speak_with_animals", "Speak with Animals", "You gain the ability to comprehend and verbally communicate with beasts for the duration. The knowledge and awareness of many beasts is limited by their intelligence, but at minimum, beasts can give you information about nearby locations and monsters, including whatever they can perceive or have perceived within the past day. You might be able to persuade a beast to perform a small favor for you, at the DM's discretion.")
            .type(DIVINATION;
            .level(L1;
            .castingTime(ActionTimes.ACTION;
            .components(SpellComponents.of(true, true);
            .duration(SpellDuration.of(600);
            .isRitual(true;
    public static final Spell SPEAK_WITH_DEAD = builder().name("speak_with_dead", "Speak with Dead", "You grant the semblance of life and intelligence to a corpse of your choice within range, allowing it to answer the questions you pose. The corpse must still have a and can't be undead. The spell fails if the corpse was the target of this spell within the last 10 days.", "Until the spell ends, you can ask the corpse up to five questions. The corpse knows only what it knew in life, including the languages it knew. Answers are usually brief, cryptic, or repetitive, and the corpse is under no compulsion to offer a truthful answer if you are hostile to it or it recognizes you as an enemy. This spell doesn't return the creature's soul to its body, only its animating spirit. Thus, the corpse can't learn new information, doesn't comprehend anything that has happened since it died, and can't speculate about future events.")
            .type(NECROMANCY;
            .level(L3;
            .castingTime(ActionTimes.ACTION;
            .range(10;
            .components(SpellComponents.of(true, true, "burning incense");
            .duration(SpellDuration.of(600);
    public static final Spell SPIKE_GROWTH = builder().name("spike_growth", "Spike Growth", "The ground in a 20-foot radius centered on a point within range twists and sprouts hard spikes and thorns. The area becomes difficult terrain for the duration. When a creature moves into or within the area, it takes 2d4 piercing damage for every 5 feet it travels.", "The transformation of the ground is camouflaged to look natural. Any creature that can't see the area at the time the spell is cast must make a Wisdom (Perception) check against your spell save DC to recognize the terrain as hazardous before entering it.")
            .type(TRANSMUTATION;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
            .range(150;
    ...
    public static final Spell SPIRITUAL_WEAPON = builder().name("spiritual_weapon", "Spiritual Weapon", "You create a floating, spectral weapon within range that lasts for the duration or until you cast this spell again. When you cast the spell, you can make melee spell attack against a creature within 5 feet of the weapon. On a hit, the target takes force damage equal to 1d8 + your spellcasting ability modifier.", "As a bonus action on your turn, you can move the weapon up to 20 feet and repeat the attack against a creature within 5 feet of it.", "The weapon can take whatever form you choose. Clerics of deities who are associated with a particular weapon (as St. Curthbert is known for his mace and Thor for his hammer) make this spell's effect resemble that weapon.", "At Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for every two slot levels above 2nd.")
            ...
            .components(SpellComponents.of(true, true);
            .duration(SpellDuration.of(ActionTimes.ONE_MINUTE);
            properties = Collections.singletonList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.FORCE, new MapUtils<SpellLevel, Dice>().add(Arrays.asList(L1, L2, L3), new Dice(8, 1)).add(L4, new Dice(8, 3)).add(L5, new Dice(8, 3)).add(L6, new Dice(8, 5)).add(L7, new Dice(8, 5)).add(Arrays.asList(L8, L9), new Dice(8, 7))));
    public static final Spell SUGGESTION = builder().name("suggestion", "Suggestions", "You suggest a course of activity (limited to a sentence or two) and magically influence a creature you can see within range that can hear and understand you. Creatures that can't be charmed are immune to this effect. The suggestion must be worded in such a manner as to make the course of action sound reasonable. Asking the creature to stab itself, throw itself onto a spear, immolate itself or do some other obviously harmful act ends the spell.", "The target must make a Wisdom saving throw. On a failed save, it pursues the course of action you described to the best of its ability. The suggested course of action can continue for the duration. If the suggested activity can be completed in a shorter time, the spell ends when the subject finishes what it was asked to do.", "You can also specify conditions that will trigger a special activity during the duration. For example, you might suggest that a knight give her warhorse to the first beggar she meets. If the condition isn't met before the spell expires, the activity isn't performed.", "If you or any of your companions damage the target, the spell ends.")
            .type(ENCHANTMENT;
            .level(L2;
            .castingTime(ActionTimes.ACTION;
            .range(30;
    ...
    public static final Spell THAUMATURGY = builder().name("thaumaturgy", "Thaumaturgy", "You manifest a minor wonder, a sign of supernatural power, within range. You create one of the following magical effects within range:", "- Your voice booms up to three times as loud as normal for 1 minute.", "- You cause flames to flicker, brighten, dim, or change color for 1 minute.", "- You cause harmless tremors in the ground for 1 minute.", "- You create an instantaneous sound that originates from a point of your choice within range, such as a rumble of thunder, the cry of a raven, or ominous whispers.", "- You instantaneously cause an unlocked door or window to fly open or slam shut.", "- You alter the appearance of your eyes for 1 minute.", "If you cast this spell multiple times, you can have up to three of its 1 minute effects active at a time, and you can dismiss such an effect as an action.")
            ...
            .components(SpellComponents.of(true, false, "");
            .duration(SpellDuration.of(ActionTimes.ONE_MINUTE);
    public static final Spell THUNDERWAVE = builder().name("thunderwave", "Thunderwave", "A wave of thunderous force sweeps out from you. Each creature in a 15-foot cube originating from you must make a Constitution saving throw. On a failed save, a creature takes 2d8 thunder damage and is pushed 10 feet away from. On a successful save, the creature takes half as much damage and isn't pushed.", "In addition, unsecured objects that are completely within the area of effect are automatically pushed 10 feet away from you by the spell's effect, and the spell emits a thunderous boom audible out to 300 feet.", "At Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d8 for each slot level above 1st.")
            .type(EVOCATION;
            .level(L1;
            .castingTime(ActionTimes.ACTION;
            .components(SpellComponents.of(true, true);
            .duration(SpellDuration.of(ActionTimes.ONE_MINUTE, true);
            properties = Arrays.asList(new SpellLevelScalableDamageProperty(getId(), DamageTypes.THUNDER, MapUtils.populateSpellLevelDiceMap(spellLevel, 8, level -> level.getValue() + 1)), new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.CONSTITUTION));
    public static final Spell TREE_STRIDE = builder().name("tree_stride", "Tree Stride", "You gain the ability to enter a tree and move from inside it to inside another tree of the same kind within 500 feet. Both trees must be living and at least the same size as you. You must use 5 feet of movement to enter a tree. You instantly know the location of all other trees of the same kind within 500 feet and, as part of the move used to enter the tree, can either pass into one of those trees or step out of the tree you're in. You appear in a spot of your choice within 5 feet of the destination tree, using another 5 feet of movement. If you have no movement left, you appear within 5 feet of the tree you entered.", "You can use this transportation ability once per round for the duration. You must end each turn outside a tree.")
            .type(CONJURATION;
            .level(L5;
            .castingTime(ActionTimes.ACTION;
            .components(SpellComponents.of(true, true);
            .duration(SpellDuration.of(ActionTimes.ONE_MINUTE, true);
    public static final Spell WALL_OF_FIRE = builder().name("wall_of_fire", "Wall of Fire", "You create a wall of fire on a solid surface within range. You can make the wall up to 60 feet long, 20 feet high, and 1 foot thick. The wall is opaque and lasts for the duration.", "When the wall appears, each creature within its area must make a Dexterity saving throw. On a failed save, a creature takes 5d8 fire damage, or half as much damage on a successful save.", "One side of the wall, selected by you when you cast this spell, deals 5d8 damage to each creature that ends its turn within 10 feet of that side or inside the wall. A creature takes the same damage when it enters the wall for the first time on a turn or ends its turn there. The other side of the wall deals no damage.", "At Higher Levels: When you cast this spell using a spell slot of 5th level or higher, the damage increases by 1d8 for each slot level above 4th.")
            .type(EVOCATION;
            .level(L4;
            .castingTime(ActionTimes.ACTION;
            .range(120;
    ...
    public static final Spell WIND_WALL = builder().name("wind_wall", "Wind Wall", "A wall of strong wind rises from the ground at a point you choose within range. You can make the wall up to 50 feet long, 15 feet high, and 1 foot thick. You can shape the wall in any way you choose so long as it makes one continuous path along the ground. The wall lasts for the duration.", "When the wall appears each creature within its area must make a Strength saving throw. A creature takes 3d8 bludgeoning damage on a failed save, or half as much damage on a successful one.", "The strong winds keep fog, smoke, and other gases at bay. Small or smaller flying creatures or objects can't pass through the wall. loose, lightweight materials brought into the wall fly upward. Arrows, bolts, and other ordinary projectiles launched at targets behind the wall are deflected upward and automatically miss. (Boulders hurled by giants or siege engines, and similar projectiles are unaffected.) Creatures in a gaseous form can't pass through it.")
            ...
            .duration(SpellDuration.of(60, true);
            properties = Arrays.asList(new AbilityScoreDCSaveProperty(getId(), AbilityScoreTypes.STRENGTH), new SingleValueProperty<>(getId() + ".property.single.damage", new Damage(DamageTypes.BLUDGEONING, new Dice(8, 3))));
}
