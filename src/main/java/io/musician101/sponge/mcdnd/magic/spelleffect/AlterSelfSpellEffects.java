...
{
    public static final SpellEffect AQUATIC_ADAPTATION = builder().name("Aquatic Adaptation")
            ...
            .build();
    public static final SpellEffect CHANGE_APPEARANCE = builder().name("Change Appearance")
