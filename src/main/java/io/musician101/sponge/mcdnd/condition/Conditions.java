...
public class Conditions
{
    ...
    private static class Paralyzed extends Condition
    {
        private Paralyzed()
        {
            ...
            properties = Arrays.asList(new SingleValueProperty<>(getId() + ".property.single_value.condition", INCAPACITATED), new ListProperty<>(getId() + ".property.list.ability_score_type", Arrays.asList(AbilityScoreTypes.STRENGTH, AbilityScoreTypes.DEXTERITY)), new SingleValueProperty<>(getId() + ".property.single_value.integer", 5));
        }
    }
    ...
    private static class Petrified extends Condition
    {
        private Petrified()
        {
            ...
            properties = Arrays.asList(new SingleValueProperty<>(getId() + ".property.single_value.condition", INCAPACITATED), new SingleValueProperty<Function<Integer, Integer>>(getId() + ".property.single_value.function", num -> num * 10), new ListProperty<>(getId() + ".property.list.ability_score_type", Arrays.asList(AbilityScoreTypes.STRENGTH, AbilityScoreTypes.DEXTERITY)), new ListProperty<>(getId() + ".property.list.damage_type", DamageTypes.ALL));
        }
    }
    ...
    private static class Restrained extends Condition
    {
        private Restrained()
        {
            ...
            properties = Arrays.asList(new SingleValueProperty<>(getId() + ".property.single_value.integer", 0), new SingleValueProperty<>(getId() + ".property.single_value.ability_score_type", AbilityScoreTypes.DEXTERITY));
        }
    }
    ...
    private static class Stunned extends Condition
    {
        private Stunned()
        {
            ...
            properties = Arrays.asList(new SingleValueProperty<>(getId() + ".property.single_value.condition", INCAPACITATED), new ListProperty<>(getId() + ".property.list.ability_score_type", Arrays.asList(AbilityScoreTypes.STRENGTH, AbilityScoreTypes.DEXTERITY)));
        }
    }
