...
public class RockGnomeTraits
{
    public static final Trait ABILITY_SCORE_INCREASE = builder().name("Ability Score Increase")
            ...
            .build();
    public static final Trait ARTIFICERS_LORE = builder().name("Artificer's Lore")
            .addProperty(MCDNDKeys.SKILL_TYPE, SkillTypes.HISTORY)
            .description("Whenever you make an Intelligence (History) check related to magic items, alchemical objects, or technological devices, you can add twice your proficiency bonus, instead of any proficiency bonus you normally apply.")
            .build();
    public static final Trait TINKER = builder().name("Tinker")
            .addProperty(MCDNDKeys.TOOL, ArtisanTools.TINKERS_TOOLS)
            ...
            .addLineToDescription("When you create a device, choose one of the following options:")
            .addLineToDescription("Clockwork Toy: This toy is a clockwork animal, monster, or person, such as a frog, mouse, bird, dragon, or soldier. When placed on the ground, the toy moves 5 feet across the ground on each of your turns in a random direction. It makes noises as appropriate to the creature it represents.")
            .addLineToDescription("Fire Starter: The device produces a miniature flame, which you can use to light a candle, torch, or campfire. Using the device requires your action.")
            .addLineToDescription("Music Box: When opened, this music box plays a single song at a moderate volume. The box stops playing when it reaches the song's end or when it is closed.")
            .build();
