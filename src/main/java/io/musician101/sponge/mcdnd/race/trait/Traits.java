...
import io.musician101.sponge.mcdnd.race.trait.ListTrait.AbilityScoreIncreaseTrait;
import io.musician101.sponge.mcdnd.race.trait.ListTrait.LanguagesTrait;
import io.musician101.sponge.mcdnd.race.trait.MappedTrait.SpellcastingTrait;
import io.musician101.sponge.mcdnd.race.trait.MappedTrait.SubraceTrait;
import io.musician101.sponge.mcdnd.race.trait.SingleValueTrait.DarkvisionTrait;
import io.musician101.sponge.mcdnd.race.trait.SingleValueTrait.MovementSpeedTrait;
import io.musician101.sponge.mcdnd.race.trait.Trait.AlignmentTrait;
...
public class Traits
{
    ...
    {
        public static final Trait DRAGONBORN_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScoreData(AbilityScoreTypes.STRENGTH, 2), new AbilityScoreData(AbilityScoreTypes.CHARISMA, 1)), "Your Strength score increases by 2, and your Charisma score increases by 1.");
    ...
    public static class Dwarf
    {
        ...
        {
            public static final Trait DWARF_HILL_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.WISDOM, 1)), "Your Wisdom score increases by 1.");
        ...
        {
            public static final Trait DWARF_MOUNTAIN_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.STRENGTH, 2)), "Your Strength score increases by 2.");
            public static final Trait DWARVEN_ARMOR_TRAINING = new ListTrait<>("Dwarven Armor Training", Arrays.asList(ArmorTypes.LIGHT, ArmorTypes.MEDIUM), "You have proficiency with light and medium armor.");
        ...
        {
            public static final Trait DWARF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.CONSTITUTION, 2)), "Your Constitution score increases by 2");
            ...
            public static final Trait STONECUNNING = new SingleValueTrait<>("Stonecunning", SkillTypes.HISTORY, "Whenever you make an Intelligence (History) check related to the origin of stonework, you are considered proficient int the History skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus.");
    ...
    public static class Elf
    {
        ...
        public static final Trait ELF_WEAPON_TRAINING = new ListTrait<>("Elf Weapon Training", Arrays.asList(Weapons.LONGSWORD, Weapons.SHORTSWORD, Weapons.SHORTBOW, Weapons.LONGBOW), "You have proficiency with the longsword, shortsword, shortbow, and longbow.");

        public static class Dark
        {
            public static final Trait ELF_DARK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.CHARISMA, 1)), "Your Charisma score increases by 1.");
            ...
            public static final Trait ELF_DARK_SIZE = new SizeTrait(4 * 12 + 5, new Dice(6, 2), 75, new Dice(4, 2),
                    CharacterSize.MEDIUM, "Elves range from under 5 to over 6 feet tall and have slender builds. Your size is Medium.");
            public static final Trait SUNLIGHT_SENSITIVITY = new SingleValueTrait<>("Sunlight Sensitivity", SkillTypes.PERCEPTION, "You have disadvantage on attack rolls and on Wisdom (Perception) checks that rely on sight when you, the target of your attack, or whatever you are trying to perceive is in direct sunlight.");
            public static final Trait DROW_MAGIC = new SpellcastingTrait("Drow Magic", new CustomMap<Integer, Spell>().add(1, Spells.DANCING_LIGHTS).add(3, Spells.FAERIE_FIRE).add(5, Spells.DARKNESS), AbilityScoreTypes.CHARISMA, "You know the dancing lights cantrip. When you reach 3rd level, you can cast the faerie fire spell once per day. When you reach 5th level, you can also cast the darkness spell once per day. Charisma is your spellcasting ability for these spells.");
            public static final Trait DROW_WEAPON_TRAINING = new ListTrait<>("Drow Weapon Training", Arrays.asList(Weapons.RAPIER, Weapons.SHORTSWORD, Weapons.HAND_CROSSBOW), "You have proficiency with rapiers, shortswords, and hand crossbows.");
        ...
        {
            public static final Trait ELF_HIGH_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.INTELLIGENCE, 1)), "Your Intelligence score increases by 1.");
            ...
            public static final Trait CANTRIP = new SingleValueTrait<>("Cantrip", AbilityScoreTypes.INTELLIGENCE, "You know one cantrip of your choice from the wizard spell list. Intelligence is your spellcasting ability for it.");
        ...
        {
            public static final Trait ELF_WOOD_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.WISDOM, 1)), "Your Wisdom score increases by 1.");
            ...
            public static final Trait FLEET_OF_FOOT = new SingleValueTrait<>("Fleet of Foot", 35, "Your base walking speed increases to 35 feet.");
        ...
        public static class Base
        {
            public static final Trait ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.DEXTERITY, 2)), "Your Strength score increases by 2.");
            ...
            public static final Trait KEEN_SENSES = new SingleValueTrait<>("Keen Senses", SkillTypes.PERCEPTION, "You have proficiency in the Perception skill.");
    ...
    public static class Gnome
    {
        ...
        {
            public static final Trait GNOME_FOREST_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.DEXTERITY, 1)), "Your Dexterity score increases by 1.");
            public static final Trait NATURAL_ILLUSIONIST = new SingleValueTrait<>("Natural Illusionist", Spells.MINOR_ILLUSION, "You know the Minor Illusion cantrip. Intelligence is your spellcasting ability for it.");
        ...
        {
            public static final Trait GNOME_ROCK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.CONSTITUTION, 1)), "Your Constitution score increases by 1.");
            public static final Trait ARTIFICERS_LORE = new SingleValueTrait<>("Artificer's Lore", SkillTypes.HISTORY, "Whenever you make an Intelligence (History) check related to magic items, alchemical objects, or technological devices, you can add twice your proficiency bonus, instead of any proficiency bonus you normally apply.");
            public static final Trait TINKER = new SingleValueTrait<>("Tinker", Tools.TINKERS_TOOLS, "You have proficiency with artisan's tools (tinker's tools). Using those tools, you can spend 1 hour and 10 gp worth of materials to construct a Tiny clockwork device (AC5, 1 hp). The device ceases to function after 24 hours (unless you spend 1 hour repairing it to keep the device functioning), or when you use your action to dismantle it; at that time, you can reclaim the materials used to create it. You can have up to three such devices active at a time.", "When you create a device, choose one of the following options:", "Clockwork Toy: This toy is a clockwork animal, monster, or person, such as a frog, mouse, bird, dragon, or soldier. When placed on the ground, the toy moves 5 feet across the ground on each of your turns in a random direction. It makes noises as appropriate to the creature it represents.", "Fire Starter: The device produces a miniature flame, which you can use to light a candle, torch, or campfire. Using the device requires your action.", "Music Box: When opened, this music box plays a single song at a moderate volume. The box stops playing when it reaches the song's end or when it is closed.");
            public static final List<Trait> GNOME_ROCK_TRAITS = Arrays.asList(GNOME_ROCK_ASI, ARTIFICERS_LORE, TINKER);
        }

        public static class Base
        {
            public static final Trait GNOME_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.INTELLIGENCE, 2)), "Your Intelligence score increases by 2.");
            ...
            public static final ListTrait<AbilityScoreType> GNOME_CUNNING = new ListTrait<>("Gnome Cunning", Arrays.asList(AbilityScoreTypes.INTELLIGENCE, AbilityScoreTypes.WISDOM, AbilityScoreTypes.CHARISMA), "You have advantage on all Intelligence, Wisdom, and Charisma saving throws against magic.");
    ...
    {
        public static final Trait HALF_ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.CHARISMA, 2)), "Your Charisma score increases by 2, and two other ability scores of your choice increases by 1.");
    ...
    {
        public static final Trait HALF_ORC_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScoreData
                (AbilityScoreTypes.STRENGTH, 2), new AbilityScoreData(AbilityScoreTypes.CONSTITUTION, 1)), "Your Strength score increases by 2, and your Constitution score increases by 1.");
        ...
        public static final Trait MENACING = new SingleValueTrait<>("Menacing", SkillTypes.INTIMIDATION, "You gain proficiency in the Intimidation skill.");
    ...
    public static class Halfling
    {
        ...
        {
            public static final Trait HALFLING_LIGHTFOOT_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.CHARISMA, 1)), "Your Charisma score increases by 1.");
        ...
        {
            public static final Trait HALFLING_STOUT_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.CONSTITUTION, 1)), "Your Constitution score increases by 1.");
        ...
        public static class Base
        {
            public static final Trait HALFLING_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScoreData(AbilityScoreTypes.DEXTERITY, 1)), "Your Dexterity score increases by 2.");
    ...
    {
        public static final Trait HUMAN_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScoreData(AbilityScoreTypes.CHARISMA, 1), new AbilityScoreData(AbilityScoreTypes.CONSTITUTION, 1), new AbilityScoreData(AbilityScoreTypes.DEXTERITY, 1), new AbilityScoreData(AbilityScoreTypes.INTELLIGENCE, 1), new AbilityScoreData(AbilityScoreTypes.STRENGTH, 1), new AbilityScoreData(AbilityScoreTypes.WISDOM, 1)), "Your ability scores each increases by 1.");
    ...
    {
        public static final Trait TIEFLING_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScoreData(AbilityScoreTypes.INTELLIGENCE, 1), new AbilityScoreData(AbilityScoreTypes.CHARISMA, 2)), "Your Intelligence score increases by 1, and your Charisma score increases by 2.");
        ...
        public static final Trait INFERNAL_LEGACY = new SpellcastingTrait("Infernal Legacy", new CustomMap<Integer, Spell>().add(1, Spells.THAUMATURGY).add(3, Spells.HELLISH_REBUKE).add(5, Spells.DARKNESS), AbilityScoreTypes.CHARISMA, "You know the Thaumaturgy cantrip. Once you reach 3rd level, you can cast the Hellish Rebuke spell once per day as a 2nd-level spell. Once you reach 5th level, you can also cast the Darkness spell once per day. Charisma is your spellcasting ability for these spells.");
