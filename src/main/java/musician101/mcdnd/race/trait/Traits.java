...
public class Traits
{
    ...
    {
        public static final Trait DRAGONBORN_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore(AbilityScoreTypes.STR, 2), new AbilityScore(AbilityScoreTypes.CHA, 1)), "Your Strength score increases by 2, and your Charisma score increases by 1.");
    ...
    public static class Dwarf
    {
        ...
        {
            public static final Trait DWARF_HILL_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.WIS, 1)), "Your Wisdom score increases by 1.");
        ...
        {
            public static final Trait DWARF_MOUNTAIN_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.STR, 2)), "Your Strength score increases by 2.");
        ...
        {
            public static final Trait DWARF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.CON, 2)), "Your Constitution score increases by 2");
    ...
    public static class Elf
    {
        ...
        {
            public static final Trait ELF_DARK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.CHA, 1)), "Your Charisma score increases by 1.");
        ...
        {
            public static final Trait ELF_HIGH_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.INT, 1)), "Your Intelligence score increases by 1.");
            ...
            public static final Trait CANTRIP = new SingleValueTrait<>("Cantrip", AbilityScoreTypes.INT, "You know one cantrip of your choice from the wizard spell list. Intelligence is your spellcasting ability for it.");
        ...
        {
            public static final Trait ELF_WOOD_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.WIS, 1)), "Your Wisdom score increases by 1.");
        ...
        public static class Base
        {
            public static final Trait ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.DEX, 2)), "Your Strength score increases by 2.");
    ...
    public static class Gnome
    {
        ...
        {
            public static final Trait GNOME_FOREST_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.DEX, 1)), "Your Dexterity score increases by 1.");
        ...
        {
            public static final Trait GNOME_ROCK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.CON, 1)), "Your Constitution score increases by 1.");
        ...
        public static class Base
        {
            public static final Trait GNOME_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.INT, 2)), "Your Intelligence score increases by 2.");
            ...
            public static final ListTrait<AbilityScoreType> GNOME_CUNNING = new ListTrait<>("Gnome Cunning", Arrays.asList(AbilityScoreTypes.INT, AbilityScoreTypes.WIS, AbilityScoreTypes.CHA), "You have advantage on all Intelligence, Wisdom, and Charisma saving throws against magic.");
    ...
    {
        public static final Trait HALF_ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.CHA, 2)), "Your Charisma score increases by 2, and two other ability scores of your choice increases by 1.");
    ...
    public static class HalfOrc
    {
        public static final Trait HALF_ORC_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore
                (AbilityScoreTypes.STR, 2), new AbilityScore(AbilityScoreTypes.CON, 1)), "Your Strength score increases by 2, and your Constitution score increases by 1.");
    ...
    public static class Halfling
    {
        ...
        {
            public static final Trait HALFLING_LIGHTFOOT_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.CHA, 1)), "Your Charisma score increases by 1.");
        ...
        {
            public static final Trait HALFLING_STOUT_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.CON, 1)), "Your Constitution score increases by 1.");
        ...
        public static class Base
        {
            public static final Trait HALFLING_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreTypes.DEX, 1)), "Your Dexterity score increases by 2.");
    ...
    {
        public static final Trait HUMAN_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore(AbilityScoreTypes.CHA, 1), new AbilityScore(AbilityScoreTypes.CON, 1), new AbilityScore(AbilityScoreTypes.DEX, 1), new AbilityScore(AbilityScoreTypes.INT, 1), new AbilityScore(AbilityScoreTypes.STR, 1), new AbilityScore(AbilityScoreTypes.WIS, 1)), "Your ability scores each increases by 1.");
    ...
    {
        public static final Trait TIEFLING_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore(AbilityScoreTypes.INT, 1), new AbilityScore(AbilityScoreTypes.CHA, 2)), "Your Intelligence score increases by 1, and your Charisma score increases by 2.");
