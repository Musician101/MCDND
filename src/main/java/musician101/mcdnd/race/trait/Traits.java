...
public class Traits
{
	...
	// Hill Dwarf Traits
	public static final Trait DWARF_HILL_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.WIS, 1)), "Your Wisdom score increases by 1.");
	...
	public static final Trait DWARF_MOUNTAIN_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.STR, 2)), "Your Strength score increases by 2.");
	...
	// Dwarf Traits
	public static final Trait DWARF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.CON, 2)), "Your Constitution score increases by 2");
	...
	public static final Trait STONECUNNING = new SingleValueTrait<>("Stonecunning", Skills.HISTORY, "Whenever you make an Intelligence (History) check related to the origin of stonework, you are considered proficient int the History skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus.");
	...
	public static final Trait ELF_DARK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.CHA, 1)), "Your Charisma score increases by 1.");
	...
	public static final Trait SUNLIGHT_SENSITIVITY = new SingleValueTrait<>("Sunlight Sensitivity", Skills.PERCEPTION, "You have disadvantage on attack rolls and on Wisdom (Perception) checks that rely on sight when you, the target of your attack, or whatever you are trying to perceive is in direct sunlight.");
	...
	// High Elf Traits
	public static final Trait ELF_HIGH_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.INT, 1)), "Your Intelligence score increases by 1.");
	...
	public static final Trait CANTRIP = new SingleValueTrait<>("Cantrip", AbilityScores.INT, "You know one cantrip of your choice from the wizard spell list. Intelligence is your spellcasting ability for it.");
	...
	// Wood Elf Traits
	public static final Trait ELF_WOOD_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.WIS, 1)), "Your Wisdom score increases by 1.");
	...
	// Elf Traits
	public static final Trait ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.DEX, 2)), "Your Strength score increases by 2.");
	...
	public static final Trait KEEN_SENSES = new SingleValueTrait<>("Keen Senses", Skills.PERCEPTION, "You have proficiency in the Perception skill.");
	...
	// Forest Gnome Traits
	public static final Trait GNOME_FOREST_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.DEX, 1)), "Your Dexterity score increases by 1.");
	...
	// Rock Gnome Traits
	public static final Trait GNOME_ROCK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.CON, 1)), "Your Constitution score increases by 1.");
	public static final Trait ARTIFICERS_LORE = new SingleValueTrait<>("Artificer's Lore", Skills.HISTORY, "Whenever you make an Intelligence (History) check related to magic items, alchemical objects, or technological devices, you can add twice your proficiency bonus, instead of any proficiency bonus you normally apply.");
	...
	// Gnome Traits
	public static final Trait GNOME_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.INT, 2)), "Your Intelligence score increases by 2.");
	...
	public static final ListTrait<AbilityScores> GNOME_CUNNING = new ListTrait<>("Gnome Cunning", Arrays.asList(AbilityScores.INT, AbilityScores.WIS, AbilityScores.CHA), "You have advantage on all Intelligence, Wisdom, and Charisma saving throws against magic.");
	...
	// Half-Elf Traits
	public static final Trait HALF_ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.CHA, 2)), "Your Charisma score increases by 2, and two other ability scores of your choice increases by 1.");
	...
	public static final Trait MENACING = new SingleValueTrait<>("Menacing", Skills.INTIMIDATION, "You gain proficiency in the Intimidation skill.");
	...
	public static final Trait HALFLING_LIGHTFOOT_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.CHA, 1)), "Your Charisma score increases by 1.");
	...
	public static final Trait HALFLING_STOUT_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.CON, 1)), "Your Constitution score increases by 1.");
	...
	// Halfing Traits
	public static final Trait HALFLING_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScores.DEX, 1)), "Your Dexterity score increases by 2.");
