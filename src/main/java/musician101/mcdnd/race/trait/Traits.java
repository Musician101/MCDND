...
public class Traits
{
    ...
    {
        public static final Trait DRAGONBORN_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore(AbilityScoreType.STR, 2), new AbilityScore(AbilityScoreType.CHA, 1)), "Your Strength score increases by 2, and your Charisma score increases by 1.");
    ...
    public static class Dwarf
    {
        ...
        {
            public static final Trait DWARF_HILL_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.WIS, 1)), "Your Wisdom score increases by 1.");
        ...
        {
            public static final Trait DWARF_MOUNTAIN_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.STR, 2)), "Your Strength score increases by 2.");
        ...
        {
            public static final Trait DWARF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.CON, 2)), "Your Constitution score increases by 2");
    ...
    public static class Elf
    {
        ...
        {
            public static final Trait ELF_DARK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.CHA, 1)), "Your Charisma score increases by 1.");
            ...
            public static final Trait SUNLIGHT_SENSITIVITY = new SingleValueTrait<>("Sunlight Sensitivity", SkillType.PERCEPTION, "You have disadvantage on attack rolls and on Wisdom (Perception) checks that rely on sight when you, the target of your attack, or whatever you are trying to perceive is in direct sunlight.");
            public static final Trait DROW_MAGIC = new SpellcastingTrait("Drow Magic", new CustomMap<Integer, Spell>().add(1, Spells.DANCING_LIGHTS).add(3, Spells.FAERIE_FIRE).add(5, Spells.DARKNESS), AbilityScoreType.CHA, "You know the dancing lights cantrip. When you reach 3rd level, you can cast the faerie fire spell once per day. When you reach 5th level, you can also cast the darkness spell once per day. Charisma is your spellcasting ability for these spells.");
        ...
        {
            public static final Trait ELF_HIGH_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.INT, 1)), "Your Intelligence score increases by 1.");
            ...
            public static final Trait CANTRIP = new SingleValueTrait<>("Cantrip", AbilityScoreType.INT, "You know one cantrip of your choice from the wizard spell list. Intelligence is your spellcasting ability for it.");
        ...
        {
            public static final Trait ELF_WOOD_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.WIS, 1)), "Your Wisdom score increases by 1.");
        ...
        public static class Base
        {
            public static final Trait ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.DEX, 2)), "Your Strength score increases by 2.");
    ...
    public static class Gnome
    {
        ...
        {
            public static final Trait GNOME_FOREST_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.DEX, 1)), "Your Dexterity score increases by 1.");
        ...
        {
            public static final Trait GNOME_ROCK_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.CON, 1)), "Your Constitution score increases by 1.");
            public static final Trait ARTIFICERS_LORE = new SingleValueTrait<>("Artificer's Lore", SkillType.HISTORY, "Whenever you make an Intelligence (History) check related to magic items, alchemical objects, or technological devices, you can add twice your proficiency bonus, instead of any proficiency bonus you normally apply.");
        ...
        public static class Base
        {
            public static final Trait GNOME_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.INT, 2)), "Your Intelligence score increases by 2.");
    ...
    {
        public static final Trait HALF_ELF_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.CHA, 2)), "Your Charisma score increases by 2, and two other ability scores of your choice increases by 1.");
    ...
    public static class HalfOrc
    {
        public static final Trait HALF_ORC_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore
                (AbilityScoreType.STR, 2), new AbilityScore(AbilityScoreType.CON, 1)), "Your Strength score increases by 2, and your Constitution score increases by 1.");
    ...
    public static class Halfling
    {
        ...
        {
            public static final Trait HALFLING_LIGHTFOOT_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.CHA, 1)), "Your Charisma score increases by 1.");
        ...
        public static class Base
        {
            public static final Trait HALFLING_ASI = new AbilityScoreIncreaseTrait(Collections.singletonList(new AbilityScore(AbilityScoreType.DEX, 1)), "Your Dexterity score increases by 2.");
    ...
    {
        public static final Trait HUMAN_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore(AbilityScoreType.CHA, 1), new AbilityScore(AbilityScoreType.CON, 1), new AbilityScore(AbilityScoreType.DEX, 1), new AbilityScore(AbilityScoreType.INT, 1), new AbilityScore(AbilityScoreType.STR, 1), new AbilityScore(AbilityScoreType.WIS, 1)), "Your ability scores each increases by 1.");
    ...
    {
        public static final Trait TIEFLING_ASI = new AbilityScoreIncreaseTrait(Arrays.asList(new AbilityScore(AbilityScoreType.INT, 1), new AbilityScore(AbilityScoreType.CHA, 2)), "Your Intelligence score increases by 1, and your Charisma score increases by 2.");
