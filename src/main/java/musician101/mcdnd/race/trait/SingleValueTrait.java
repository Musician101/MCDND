...
public class SingleValueTrait<T> extends Trait
{
    ...
    public static class DarkvisionTrait extends SingleValueTrait<Integer>
    {
        ...
        {
            this("Darkvision", 60, description + " You can see in dim light within 60 feet of you as if it were " +
                    "bright light, and in darkness as if it were dim light. You can't discern color in darkness, only" +
                    " shades of gray.");
        }
