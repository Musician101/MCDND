...
public class Armors
{
    ...
    private static final Armor STUDDED_LEATHER = new Armor("Studded Leather", ArmorTypes.LIGHT, new Cost(CurrencyTypes.GOLD, 45), 12, 0, false, 13);
    private static final Armor HIDE = new Armor("Hide", ArmorTypes.MEDIUM, new Cost(CurrencyTypes.GOLD, 10), 12, 0, false, 12);
    private static final Armor CHAIN_SHIRT = new Armor("Chain Shirt", ArmorTypes.MEDIUM, new Cost(CurrencyTypes.GOLD, 50), 13, 0, false, 20);
    private static final Armor BREASTPLATE = new Armor("Breastplate", ArmorTypes.MEDIUM, new Cost(CurrencyTypes.GOLD, 400), 14, 0, false, 20);
    private static final Armor HALF_PLATE = new Armor("Half Plate", ArmorTypes.MEDIUM, new Cost(CurrencyTypes.GOLD, 750), 15, 0, false, 20);
    private static final Armor RING_MAIL = new Armor("Ring Mail", ArmorTypes.HEAVY, new Cost(CurrencyTypes.GOLD, 30), 14, 0, false, 20);
    private static final Armor SPLINT = new Armor("Splint", ArmorTypes.HEAVY, new Cost(CurrencyTypes.GOLD, 200), 17, 0, false, 20);
    private static final Armor PLATE = new Armor("Plate", ArmorTypes.HEAVY, new Cost(CurrencyTypes.GOLD, 1500), 18, 0, false, 20);
