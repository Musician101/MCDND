...
public class Packs
{
	public static final Pack BURGLARS_PACK = new Pack("Burglar's Pack", new Cost(CurrencyType.GOLD, 16), new CustomHashMap<Equipment, Integer>()
	...
	public static final Pack DIPLOMATS_PACK = new Pack("Diplomat's Pack", new Cost(CurrencyType.GOLD, 39), new CustomHashMap<Equipment, Integer>()
	...
	public static final Pack DUNGEONEERS_PACK = new Pack("Dungeoneer's Pack", new Cost(CurrencyType.GOLD, 12), new CustomHashMap<Equipment, Integer>()
	...
	public static final Pack PRIESTS_PACK = new Pack("Priest's Pack", new Cost(CurrencyType.GOLD, 19), new CustomHashMap<Equipment, Integer>()
	...
	public static final Pack SCHOLARS_PACK = new Pack("Scholar's Pack", new Cost(CurrencyType.GOLD, 40), new CustomHashMap<Equipment, Integer>()
