...
public class Tools
{
    public static final Tool ALCHEMISTS_SUPPLIES = new ArtisanTool("Alchemist's Supplies", new Cost(CurrencyType
            .GOLD, 50), 8);
    public static final Tool BREWERS_SUPPLIES = new ArtisanTool("Brewer's Supplies", new Cost(CurrencyType.GOLD, 20),
            9);
    public static final Tool CALLIGRAPHERS_SUPPLIES = new ArtisanTool("Calligrapher's Supplies", new Cost
            (CurrencyType.GOLD, 10), 5);
    public static final Tool CARPENTERS_TOOLS = new ArtisanTool("Carpenter's Tools", new Cost(CurrencyType.GOLD, 8), 6);
    public static final Tool CARTOGRAPHERS_TOOLS = new ArtisanTool("Cartographer's Tools", new Cost(CurrencyType
            .GOLD, 15), 6);
    ...
    public static final Tool GLASSBLOWERS_TOOLS = new ArtisanTool("Glassblower's Tools", new Cost(CurrencyType.GOLD,
            30), 5);
    public static final Tool JEWELERS_TOOLS = new ArtisanTool("Jeweler's Tools", new Cost(CurrencyType.GOLD, 25), 2);
    public static final Tool LEATHERWORKERS_TOOLS = new ArtisanTool("Leatherworker's Tools", new Cost(CurrencyType
            .GOLD, 5), 5);
    public static final Tool MASONS_TOOLS = new ArtisanTool("Mason's Tools", new Cost(CurrencyType.GOLD, 10), 8);
    public static final Tool PAINTERS_SUPPLIES = new ArtisanTool("Painter's Supplies", new Cost(CurrencyType.GOLD,
            10), 5);
    ...
    public static final Tool WOODCARVERS_TOOLS = new ArtisanTool("Woodcarver's Tools", new Cost(CurrencyType.GOLD, 1)
            , 5);
    ...
    public static final Tool THREE_DRAGON_ANTE_SET = new GamingSet("Three Dragon Ante Set", new Cost(CurrencyType
            .GOLD, 1), 0);
    ...
    {
        return new CustomList<>(ALCHEMISTS_SUPPLIES, BREWERS_SUPPLIES, CALLIGRAPHERS_SUPPLIES, CARPENTERS_TOOLS,
                COBBLERS_TOOLS, COOKS_UTENSILS, GLASSBLOWERS_TOOLS, JEWELERS_TOOLS, LEATHERWORKERS_TOOLS,
    ...
    {
        return new CustomList<>(DISGUISE_KIT, FORGERY_KIT, HERBALISM_KIT, NAVIGATORS_TOOLS, POISONERS_KIT,
                THIEVES_TOOLS);
    }
}
