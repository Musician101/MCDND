...
import musician101.mcdnd.equipment.weapon.property.WeaponProperty.RangeWeaponProperty;
import musician101.mcdnd.equipment.weapon.property.WeaponProperty.VersatileWeaponProperty;

public class WeaponProperties
{
	public static final WeaponProperty AMMUNITION = new WeaponProperty("Ammunition", "You can use a weapon that has the ammunition property to make a ranged attack only if you have ammunition to fire the weapon. Each time you attack with the weapon, you expend one piece of ammunition. Drawing the ammunition from a quiver case, or other container is part of the attack. At the end of the battle, you can recover half your expended ammunition by taking a minute to search the battle field.\n" +
