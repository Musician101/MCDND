...
{
	public static final Weapon CLUB = new Weapon("Club", new Cost(CurrencyType.SILVER, 1), new Damage(DamageType.BLUDGEONING, new Dice(4)), 2, Collections.singletonList(WeaponProperties.LIGHT), WeaponType.SIMPLE_MELEE);
	...
	public static final Weapon GREATCLUB = new Weapon("Greatclub", new Cost(CurrencyType.SILVER, 2), new Damage(DamageType.BLUDGEONING, new Dice(8)), 10, Collections.singletonList(WeaponProperties.TWO_HANDED), WeaponType.SIMPLE_MELEE);
	...
	public static final Weapon QUARTERSTAFF = new Weapon("Quarterstaff", new Cost(CurrencyType.SILVER, 2), new Damage(DamageType.BLUDGEONING, new Dice(6)), 4, Collections.singletonList(WeaponProperties.VERSATILE_D8), WeaponType.SIMPLE_MELEE);
	public static final Weapon SICKLE = new Weapon("Sickle", new Cost(CurrencyType.GOLD, 1), new Damage(DamageType.SLASHING, new Dice(4)), 2, Collections.singletonList(WeaponProperties.LIGHT), WeaponType.SIMPLE_MELEE);
	...
	public static final Weapon BATTLEAXE = new Weapon("Battleaxe", new Cost(CurrencyType.GOLD, 10), new Damage(DamageType.SLASHING, new Dice(8)), 4, Collections.singletonList(WeaponProperties.VERSATILE_D10), WeaponType.MARTIAL_MELEE);
	...
	public static final Weapon LONGSWORD = new Weapon("Longsword", new Cost(CurrencyType.GOLD, 15), new Damage(DamageType.SLASHING, new Dice(8)), 3, Collections.singletonList(WeaponProperties.VERSATILE_D10), WeaponType.MARTIAL_MELEE);
	...
	public static final Weapon RAPIER = new Weapon("Rapier", new Cost(CurrencyType.GOLD, 25), new Damage(DamageType.PIERCING, new Dice(8)), 2, Collections.singletonList(WeaponProperties.FINESSE), WeaponType.MARTIAL_MELEE);
	...
	public static final Weapon WARHAMMER = new Weapon("Warhammer", new Cost(CurrencyType.GOLD, 15), new Damage(DamageType.BLUDGEONING, new Dice(8)), 2, Collections.singletonList(WeaponProperties.VERSATILE_D10), WeaponType.MARTIAL_MELEE);
	...
	{
		return new CustomList<>(CLUB, DAGGER, GREATCLUB, HANDAXE, JAVELIN, LIGHT_HAMMER, MACE, QUARTERSTAFF, SICKLE, SPEAR, UNARMED_STRIKE);
	}
	...
	{
		return new CustomList<>(BATTLEAXE, FLAIL, GLAIVE, GREATAXE, GREATSWORD, HALBERD, LANCE, LONGSWORD, MAUL, MORNINGSTAR, PIKE, RAPIER, SCIMITAR, SHORTSWORD, TRIDENT, WAR_PICK, WARHAMMER, WHIP);
	}
