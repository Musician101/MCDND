...
public class AdventuringGear
{
	...
	public static final Gear ALCHEMIST_S_FIRE_FLASK = new Gear("Alchemist's Fire (Flask)", new Cost(CurrencyType.GOLD, 50), 1);
	...
	public static final Gear BLOWGUN_NEEDLES = new AmmunitionGear("Blowgun Needles", 50, new Cost(CurrencyType.GOLD, 1), 1);
	public static final Gear CROSSBOW_BOLTS = new AmmunitionGear("Crossbow Bolts", 20, new Cost(CurrencyType.GOLD, 1), 1.5);
	public static final Gear SLING_BULLETS = new AmmunitionGear("Sling Bullets", 20, new Cost(CurrencyType.COPPER, 4), 1.5);
	public static final Gear ANTITOXIN_VIAL = new Gear("Antitoxin (Vial)", new Cost(CurrencyType.GOLD, 50), 0);
	public static final Gear ARCANE_FOCUS_CRYSTAL = new ArcaneFocusGear("Arcane Focus (Crystal)", new Cost(CurrencyType.GOLD, 10), 1);
	public static final Gear ARCANE_FOCUS_ORB = new ArcaneFocusGear("Arcane Focus (Orb)", new Cost(CurrencyType.GOLD, 20), 3);
	public static final Gear ARCANE_FOCUS_ROD = new ArcaneFocusGear("Arcane Focus (Rod)", new Cost(CurrencyType.GOLD, 10), 2);
	public static final Gear ARCANE_FOCUS_STAFF = new ArcaneFocusGear("Arcane Focus (Staff)", new Cost(CurrencyType.GOLD, 5), 4);
	public static final Gear ARCANE_FOCUS_WAND = new ArcaneFocusGear("Arcane Focus (Wand)", new Cost(CurrencyType.GOLD, 10), 1);
	public static final Gear BACKPACK = new Gear("Backpack", new Cost(CurrencyType.GOLD, 2), 5);
	public static final Gear BALL_BEARINGS = new BundledGear("Ball Bearings (bag of 1,000)", 1000, new Cost(CurrencyType.GOLD, 1), 2);
	...
	public static final Gear DRUIDIC_FOCUS_SPRIG_MISTLETOE = new DruidicFocusGear("Sprig of Mistletoe", new Cost(CurrencyType.GOLD, 1), 0);
	public static final Gear DRUIDIC_FOCUS_TOTEM = new DruidicFocusGear("Totem", new Cost(CurrencyType.GOLD, 1), 0);
	public static final Gear DRUIDIC_FOCUS_WOODEN_STAFF = new DruidicFocusGear("Wooden Staff", new Cost(CurrencyType.GOLD, 5), 4);
	public static final Gear DRUIDIC_FOCUS_YEW_WAND = new DruidicFocusGear("Yew Wand", new Cost(CurrencyType.GOLD, 10), 1);
	...
	public static final Gear HOLY_SYMBOL_RELIQUARY = new Gear("Holy Symbol (Reliquary)", new Cost(CurrencyType.GOLD, 5), 2);
