...
public class ScryingSpell extends Spell
{
	...
	public ScryingSpell()
	{
		super("Scrying", SpellType.DIVINATION, SpellLevel.LEVEL_5, 600, 0, true, true, "a focus worth at least 1,000 gp, such as a crystal ball, a silver mirror, or a font filled with holy water", 600, true,
