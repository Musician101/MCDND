...
public class Spells
{
	public static final ScaleableDamageSpell<Integer> ACID_SPLASH = new ScaleableDamageSpell<Integer>("Acid Splash", SpellType.CONJURATION, SpellLevel.CANTRIP, -1, 60, true, true, false, new CustomHashMap<Integer, Dice>().add(1, new Dice(6)).add(5, new Dice(6, 2)).add(11, new Dice(6, 3)).add(17, new Dice(6, 4)), DamageType.ACID, "You hurl a bubble of acid. Choose on creature within range, or choose two creatures within range that are within 5 feet of each other. A target must succeed on a Dexterity saving throw or take 1d6 acid damage.");
	public static final MultipleSpellSlotSpell AID = new MultipleSpellSlotSpell("Aid", SpellType.ABJURATION, SpellLevel.LEVEL_2, -1, 30, true, true, "a tiny strip of whtie cloth", 28800, false, new CustomHashMap<SpellLevel, Integer>().add(SpellLevel.LEVEL_2, 5).add(SpellLevel.LEVEL_3, 10)
