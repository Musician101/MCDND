...
public class ConfusionSpell extends ScalableEffectSpell
{
    ...
    {
        super("Confusion", SpellType.ENCHANTMENT, SpellLevel.LEVEL_4, ActionTimes.ACTION, 90, true, true, "three nut shells", 60, true, new CustomMap<SpellLevel, Integer>().add(SpellLevel.LEVEL_5, 95).add(SpellLevel.LEVEL_6, 100).add(SpellLevel.LEVEL_7, 105).add(SpellLevel.LEVEL_8, 110).add(SpellLevel.LEVEL_9, 115), SpellLevel.LEVEL_5, "This spell assaults and twists creatures' minds, spawning delusions and provoking uncontrolled action. Each creature in a 10-foot-radius sphere centered on a point you choose within range must succeed on a Wisdom saving throw when you cast this spell or be affected by it.", "An affected target can't take reactions and must roll a d10 at the start of each of its to determine its behavior for that turn.", "At the end of each of its turns, an affected target can make a Wisdom saving throw. If it succeeds, this effect ends for that target.", "At Higher Levels:When you cast this spell using a spell slot of 5th level or higher, the radius of the sphere increases by 5 feet for each slot level above 4th.");
