...
public class CharacterAbilityScores extends AbstractAbilityScores
{
    ...
    public CharacterAbilityScores(List<AbilityScores> proficientSavingThrows, ProficiencyBonus proficiencyBonus)
    {
        ...
        updateScores(new AbilityScore(AbilityScores.STR), new AbilityScore(AbilityScores.DEX), new AbilityScore
                (AbilityScores.CON), new AbilityScore(AbilityScores.INT), new AbilityScore(AbilityScores.WIS), new
    ...
    {
        return proficientSavingThrows.contains(AbilityScores.STR) ? getAbilityMod(score) + proficiencyBonus.getBonus
                () : getAbilityMod(score);
    }
